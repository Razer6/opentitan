...
module lio_rv_plic import lio_rv_plic_reg_pkg::*; #(
  ...
  lio_rv_plic_reg2hw_t reg2hw;
  lio_rv_plic_hw2reg_t hw2reg;
  ...
  // Glue logic between lio_rv_plic_reg_top and others
  ...
  assign prio[194] = reg2hw.prio[194].q;
  assign prio[195] = reg2hw.prio[195].q;
  assign prio[196] = reg2hw.prio[196].q;
  assign prio[197] = reg2hw.prio[197].q;
  assign prio[198] = reg2hw.prio[198].q;
  assign prio[199] = reg2hw.prio[199].q;
  assign prio[200] = reg2hw.prio[200].q;
  assign prio[201] = reg2hw.prio[201].q;
  assign prio[202] = reg2hw.prio[202].q;
  assign prio[203] = reg2hw.prio[203].q;
  assign prio[204] = reg2hw.prio[204].q;
  assign prio[205] = reg2hw.prio[205].q;
  assign prio[206] = reg2hw.prio[206].q;
  assign prio[207] = reg2hw.prio[207].q;
  assign prio[208] = reg2hw.prio[208].q;
  assign prio[209] = reg2hw.prio[209].q;
  assign prio[210] = reg2hw.prio[210].q;
  assign prio[211] = reg2hw.prio[211].q;
  assign prio[212] = reg2hw.prio[212].q;
  assign prio[213] = reg2hw.prio[213].q;
  assign prio[214] = reg2hw.prio[214].q;
  assign prio[215] = reg2hw.prio[215].q;
  assign prio[216] = reg2hw.prio[216].q;
  ...
  assign prio[252] = reg2hw.prio[252].q;
  assign prio[253] = reg2hw.prio[253].q;
  assign prio[254] = reg2hw.prio[254].q;
  assign prio[255] = reg2hw.prio[255].q;
  ...
  for (genvar s = 0; s < 256; s++) begin : gen_ie1
    assign ie[1][s] = reg2hw.ie1[s].q;
  end
  for (genvar s = 0; s < 256; s++) begin : gen_ie2
    assign ie[2][s] = reg2hw.ie2[s].q;
  end
  for (genvar s = 0; s < 256; s++) begin : gen_ie3
    assign ie[3][s] = reg2hw.ie3[s].q;
  end
  for (genvar s = 0; s < 256; s++) begin : gen_ie4
    assign ie[4][s] = reg2hw.ie4[s].q;
  end
  for (genvar s = 0; s < 256; s++) begin : gen_ie5
    assign ie[5][s] = reg2hw.ie5[s].q;
  end
  for (genvar s = 0; s < 256; s++) begin : gen_ie6
    assign ie[6][s] = reg2hw.ie6[s].q;
  end
  ...
  assign threshold[2] = reg2hw.threshold2.q;
  assign threshold[3] = reg2hw.threshold3.q;
  assign threshold[4] = reg2hw.threshold4.q;
  assign threshold[5] = reg2hw.threshold5.q;
  assign threshold[6] = reg2hw.threshold6.q;
  ...
  assign claim_re[2]    = reg2hw.cc2.re;
  assign claim_id[2]    = irq_id_o[2];
  assign complete_we[2] = reg2hw.cc2.qe;
  assign complete_id[2] = reg2hw.cc2.q;
  assign hw2reg.cc2.d   = cc_id[2];
  assign claim_re[3]    = reg2hw.cc3.re;
  assign claim_id[3]    = irq_id_o[3];
  assign complete_we[3] = reg2hw.cc3.qe;
  assign complete_id[3] = reg2hw.cc3.q;
  assign hw2reg.cc3.d   = cc_id[3];
  assign claim_re[4]    = reg2hw.cc4.re;
  assign claim_id[4]    = irq_id_o[4];
  assign complete_we[4] = reg2hw.cc4.qe;
  assign complete_id[4] = reg2hw.cc4.q;
  assign hw2reg.cc4.d   = cc_id[4];
  assign claim_re[5]    = reg2hw.cc5.re;
  assign claim_id[5]    = irq_id_o[5];
  assign complete_we[5] = reg2hw.cc5.qe;
  assign complete_id[5] = reg2hw.cc5.q;
  assign hw2reg.cc5.d   = cc_id[5];
  assign claim_re[6]    = reg2hw.cc6.re;
  assign claim_id[6]    = irq_id_o[6];
  assign complete_we[6] = reg2hw.cc6.qe;
  assign complete_id[6] = reg2hw.cc6.q;
  assign hw2reg.cc6.d   = cc_id[6];
  ...
  assign msip_o[2] = reg2hw.msip2.q;
  assign msip_o[3] = reg2hw.msip3.q;
  assign msip_o[4] = reg2hw.msip4.q;
  assign msip_o[5] = reg2hw.msip5.q;
  assign msip_o[6] = reg2hw.msip6.q;
