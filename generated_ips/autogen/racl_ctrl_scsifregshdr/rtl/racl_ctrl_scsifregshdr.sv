...
module racl_ctrl_scsifregshdr import racl_ctrl_scsifregshdr_reg_pkg::*; #(
  ...
  racl_ctrl_scsifregshdr_reg2hw_t reg2hw;
  racl_ctrl_scsifregshdr_hw2reg_t hw2reg;
  ...
  racl_ctrl_scsifregshdr_reg_top #(
    .EnableRacl   ( 1'b1         ),
