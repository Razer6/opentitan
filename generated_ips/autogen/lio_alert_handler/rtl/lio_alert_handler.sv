...
#(
  ...
  lio_alert_handler_lpg_ctrl u_alert_handler_lpg_ctrl (
    .clk_i,
    .rst_ni,
    // SEC_CM: LPG.INTERSIG.MUBI
    .lpg_cg_en_i,
  ...
  lio_alert_handler_class u_class (
  ...
  for (genvar k = 0; k < N_CLASSES; k++) begin : gen_classes
    ...
    lio_alert_handler_esc_timer u_esc_timer (
      .clk_i,
      .rst_ni,
