...
package lio_alert_handler_env_pkg;
  // dep packages
  import uvm_pkg::*;
  import top_pkg::*;
  import dv_utils_pkg::*;
  ...
  import lio_alert_handler_ral_pkg::*;
  ...
  // parameters
  parameter uint NUM_ALERTS                = lio_alert_handler_reg_pkg::NAlerts;
  ...
  parameter bit  [NUM_ALERTS-1:0] ASYNC_ON = lio_alert_handler_reg_pkg::AsyncOn;
  ...
  parameter uint NUM_CRASHDUMP             = NUM_ALERT_CLASSES * (lio_alert_handler_reg_pkg::AccuCntDw
                                             + lio_alert_handler_reg_pkg::EscCntDw + 3) +
  ...
  typedef virtual lio_alert_handler_if lio_alert_handler_vif;

  // functions

  // package sources
  `include "lio_alert_handler_env_cfg.sv"
  `include "lio_alert_handler_env_cov.sv"
  `include "lio_alert_handler_virtual_sequencer.sv"
  `include "lio_alert_handler_scoreboard.sv"
  `include "lio_alert_handler_env.sv"
