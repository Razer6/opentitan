...
class lio_alert_handler_random_alerts_vseq extends lio_alert_handler_smoke_vseq;
  `uvm_object_utils(lio_alert_handler_random_alerts_vseq)
...
endclass : lio_alert_handler_random_alerts_vseq
