...
class lio_alert_handler_ping_timeout_vseq extends lio_alert_handler_entropy_vseq;
  `uvm_object_utils(lio_alert_handler_ping_timeout_vseq)
...
endclass : lio_alert_handler_ping_timeout_vseq
