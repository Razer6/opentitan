...
class lio_alert_handler_esc_intr_timeout_vseq extends lio_alert_handler_smoke_vseq;
  `uvm_object_utils(lio_alert_handler_esc_intr_timeout_vseq)
...
endclass : lio_alert_handler_esc_intr_timeout_vseq
