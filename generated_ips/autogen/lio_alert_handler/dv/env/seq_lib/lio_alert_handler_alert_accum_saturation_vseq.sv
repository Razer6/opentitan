...
class lio_alert_handler_alert_accum_saturation_vseq extends lio_alert_handler_smoke_vseq;
  `uvm_object_utils(lio_alert_handler_alert_accum_saturation_vseq)
...
endclass : lio_alert_handler_alert_accum_saturation_vseq
