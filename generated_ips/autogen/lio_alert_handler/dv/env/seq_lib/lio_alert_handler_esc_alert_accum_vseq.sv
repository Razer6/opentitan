...
class lio_alert_handler_esc_alert_accum_vseq extends lio_alert_handler_smoke_vseq;
  `uvm_object_utils(lio_alert_handler_esc_alert_accum_vseq)
...
endclass : lio_alert_handler_esc_alert_accum_vseq
