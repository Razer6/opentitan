...
class lio_alert_handler_entropy_vseq extends lio_alert_handler_smoke_vseq;
  `uvm_object_utils(lio_alert_handler_entropy_vseq)
  ...
  // increase the possibility to enable more alerts, because lio_alert_handler only sends ping on
  // enabled alerts
...
endclass : lio_alert_handler_entropy_vseq
