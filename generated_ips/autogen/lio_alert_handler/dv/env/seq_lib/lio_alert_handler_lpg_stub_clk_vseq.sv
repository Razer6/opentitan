...
// This sequence check LPG by randomly turn off lio_alert_handler's clock, and check if ping timer can
// resume correctly without sending some spurious ping errors.
class lio_alert_handler_lpg_stub_clk_vseq extends lio_alert_handler_lpg_vseq;
  `uvm_object_utils(lio_alert_handler_lpg_stub_clk_vseq)
...
endclass : lio_alert_handler_lpg_stub_clk_vseq
