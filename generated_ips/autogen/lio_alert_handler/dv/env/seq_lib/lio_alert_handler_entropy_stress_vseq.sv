...
class lio_alert_handler_entropy_stress_vseq extends lio_alert_handler_smoke_vseq;
  `uvm_object_utils(lio_alert_handler_entropy_stress_vseq)
  ...
  virtual task pre_start();
    ...
    cfg.lio_alert_handler_vif.set_wait_cyc_mask(forced_mask_val);
  ...
  task body();
    ...
    cfg.lio_alert_handler_vif.release_wait_cyc_mask();
    dut_init();
  endtask

endclass : lio_alert_handler_entropy_stress_vseq
