...
class lio_alert_handler_smoke_vseq extends lio_alert_handler_base_vseq;
  `uvm_object_utils(lio_alert_handler_smoke_vseq)
...
endclass : lio_alert_handler_smoke_vseq
