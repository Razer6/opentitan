...
class lio_alert_handler_env_cfg extends cip_base_env_cfg #(.RAL_T(lio_alert_handler_reg_block));

  // ext component cfgs
  esc_en_vif               esc_en_vif;
  crashdump_vif            crashdump_vif;
  lio_alert_handler_vif        lio_alert_handler_vif;
  rand alert_esc_agent_cfg alert_host_cfg[];
  rand alert_esc_agent_cfg esc_device_cfg[];

  `uvm_object_utils_begin(lio_alert_handler_env_cfg)
