...
%>\
          exp_hw_cfg0_data = cfg.otp_ctrl_vif.under_error_states() ?
                             top_${topname}_rnd_cnst_pkg::RndCnstOtpCtrlPartInvDefault[HwCfg0Offset*8 +: ${part_size}*8] :
                             otp_hw_cfg0_data_t'({<<32 {otp_a[${part_size}/4 +: ${part_size}/4]}});
...
%>\
          exp_hw_cfg1_data = cfg.otp_ctrl_vif.under_error_states() ?
                             top_${topname}_rnd_cnst_pkg::RndCnstOtpCtrlPartInvDefault[HwCfg1Offset*8 +: ${part_size}*8] :
