...
package scan_role_pkg;
  ...
  parameter scan_role_e PwcPadPwc0ScanRole            = NoScan;
  parameter scan_role_e PwcPadPwc1ScanRole            = NoScan;
  parameter scan_role_e PwcPadPwc2ScanRole            = NoScan;
  parameter scan_role_e PwcPadPwc3ScanRole            = NoScan;
  parameter scan_role_e PwcPadPwc4ScanRole            = NoScan;
  parameter scan_role_e PwcPadPwc5ScanRole            = NoScan;
  parameter scan_role_e PwcPadPwc6ScanRole            = NoScan;
  parameter scan_role_e PwcPadPwc7ScanRole            = NoScan;
  parameter scan_role_e PwcPadPwc8ScanRole            = NoScan;
  parameter scan_role_e PwcPadPwc9ScanRole            = NoScan;
  parameter scan_role_e PwcPadPwc10ScanRole           = NoScan;
  parameter scan_role_e PwcPadPwc11ScanRole           = NoScan;
