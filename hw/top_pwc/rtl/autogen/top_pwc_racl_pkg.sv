...
package top_pwc_racl_pkg;
  ...
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX0_SOC_WIN_WDATA = 7;
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX0_SOC_WIN_RDATA = 7;
  ...
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX1_SOC_WIN_WDATA = 7;
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX1_SOC_WIN_RDATA = 7;
  ...
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX2_SOC_WIN_WDATA = 7;
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX2_SOC_WIN_RDATA = 7;
