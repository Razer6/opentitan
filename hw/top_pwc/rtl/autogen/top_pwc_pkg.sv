...
package top_pwc_pkg;
  ...
  */
  ...
  typedef enum int unsigned {
    ...
    TopPwcPlicPwcIrqIdPwcCcs0DvfsFsm = 145,
    TopPwcPlicPwcIrqIdPwcCcs1DvfsFsm = 146,
    TopPwcPlicPwcIrqIdPwcDvfsSocdpafsmstatus0 = 147,
    TopPwcPlicPwcIrqIdPwcDvfsSocdpafsmstatus1 = 148,
    TopPwcPlicPwcIrqIdPwcDvfsSocdpafsmstatus2 = 149,
    TopPwcPlicPwcIrqIdPwcDvfsSocdpafsmstatus3 = 150,
    TopPwcPlicPwcIrqIdPwcDvfsSocdpafsmstatus4 = 151,
    TopPwcPlicPwcIrqIdPwcDvfsSocdpafsmstatus5 = 152,
    TopPwcPlicPwcIrqIdPwcHms0Status = 153,
    TopPwcPlicPwcIrqIdPwcHms1Status = 154,
    TopPwcPlicPwcIrqIdPwcHms2Status = 155,
    TopPwcPlicPwcIrqIdPwcHms3Status = 156,
  ...
  typedef enum int unsigned {
    ...
    TopPwcIncomingIrqPwcExternalIdPwcCcs0DvfsFsm = 85,
    TopPwcIncomingIrqPwcExternalIdPwcCcs1DvfsFsm = 86,
    TopPwcIncomingIrqPwcExternalIdPwcDvfsSocdpafsmstatus0 = 87,
    TopPwcIncomingIrqPwcExternalIdPwcDvfsSocdpafsmstatus1 = 88,
    TopPwcIncomingIrqPwcExternalIdPwcDvfsSocdpafsmstatus2 = 89,
    TopPwcIncomingIrqPwcExternalIdPwcDvfsSocdpafsmstatus3 = 90,
    TopPwcIncomingIrqPwcExternalIdPwcDvfsSocdpafsmstatus4 = 91,
    TopPwcIncomingIrqPwcExternalIdPwcDvfsSocdpafsmstatus5 = 92,
    TopPwcIncomingIrqPwcExternalIdPwcHms0Status = 93,
    TopPwcIncomingIrqPwcExternalIdPwcHms1Status = 94,
    TopPwcIncomingIrqPwcExternalIdPwcHms2Status = 95,
    TopPwcIncomingIrqPwcExternalIdPwcHms3Status = 96,
