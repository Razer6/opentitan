...
package soc_proxy_reg_pkg;
  ...
  typedef struct packed {
    soc_proxy_reg2hw_intr_state_reg_t intr_state; // [98:67]
    soc_proxy_reg2hw_intr_enable_reg_t intr_enable; // [66:35]
    soc_proxy_reg2hw_intr_test_reg_t intr_test; // [34:2]
  ...
  parameter logic [3:0] SOC_PROXY_CORE_PERMIT [4] = '{
    ...
    4'b 0001  // index[3] SOC_PROXY_ALERT_TEST
  };
