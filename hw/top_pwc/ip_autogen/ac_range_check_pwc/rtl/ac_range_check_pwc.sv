...
module ac_range_check_pwc
  import tlul_pkg::*;
  import ac_range_check_pwc_reg_pkg::*;
#(
  ...
  ac_range_check_pwc_reg2hw_t reg2hw;
  ac_range_check_pwc_hw2reg_t hw2reg;
