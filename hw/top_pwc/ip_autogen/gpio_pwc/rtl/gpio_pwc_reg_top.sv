...
module gpio_pwc_reg_top
  # (
    parameter bit          EnableRacl           = 1'b0,
    parameter bit          RaclErrorRsp         = 1'b1,
    parameter top_racl_pkg::racl_policy_sel_t RaclPolicySelVec[gpio_pwc_reg_pkg::NumRegs] =
      '{gpio_pwc_reg_pkg::NumRegs{0}}
  ) (
  input clk_i,
  input rst_ni,
  ...
  // To HW
  output gpio_pwc_reg_pkg::gpio_pwc_reg2hw_t reg2hw, // Write
  input  gpio_pwc_reg_pkg::gpio_pwc_hw2reg_t hw2reg, // Read
  ...
  always_comb begin
    ...
    addr_hit[ 0] = (reg_addr == GPIO_PWC_INTR_STATE_OFFSET);
    addr_hit[ 1] = (reg_addr == GPIO_PWC_INTR_ENABLE_OFFSET);
    addr_hit[ 2] = (reg_addr == GPIO_PWC_INTR_TEST_OFFSET);
    addr_hit[ 3] = (reg_addr == GPIO_PWC_ALERT_TEST_OFFSET);
    addr_hit[ 4] = (reg_addr == GPIO_PWC_DATA_IN_OFFSET);
    addr_hit[ 5] = (reg_addr == GPIO_PWC_DIRECT_OUT_OFFSET);
    addr_hit[ 6] = (reg_addr == GPIO_PWC_MASKED_OUT_LOWER_OFFSET);
    addr_hit[ 7] = (reg_addr == GPIO_PWC_MASKED_OUT_UPPER_OFFSET);
    addr_hit[ 8] = (reg_addr == GPIO_PWC_DIRECT_OE_OFFSET);
    addr_hit[ 9] = (reg_addr == GPIO_PWC_MASKED_OE_LOWER_OFFSET);
    addr_hit[10] = (reg_addr == GPIO_PWC_MASKED_OE_UPPER_OFFSET);
    addr_hit[11] = (reg_addr == GPIO_PWC_INTR_CTRL_EN_RISING_OFFSET);
    addr_hit[12] = (reg_addr == GPIO_PWC_INTR_CTRL_EN_FALLING_OFFSET);
    addr_hit[13] = (reg_addr == GPIO_PWC_INTR_CTRL_EN_LVLHIGH_OFFSET);
    addr_hit[14] = (reg_addr == GPIO_PWC_INTR_CTRL_EN_LVLLOW_OFFSET);
    addr_hit[15] = (reg_addr == GPIO_PWC_CTRL_EN_INPUT_FILTER_OFFSET);
    addr_hit[16] = (reg_addr == GPIO_PWC_HW_STRAPS_DATA_IN_VALID_OFFSET);
    addr_hit[17] = (reg_addr == GPIO_PWC_HW_STRAPS_DATA_IN_OFFSET);
  ...
  always_comb begin
    wr_err = (reg_we &
              ((racl_addr_hit_write[ 0] & (|(GPIO_PWC_PERMIT[ 0] & ~reg_be))) |
               (racl_addr_hit_write[ 1] & (|(GPIO_PWC_PERMIT[ 1] & ~reg_be))) |
               (racl_addr_hit_write[ 2] & (|(GPIO_PWC_PERMIT[ 2] & ~reg_be))) |
               (racl_addr_hit_write[ 3] & (|(GPIO_PWC_PERMIT[ 3] & ~reg_be))) |
               (racl_addr_hit_write[ 4] & (|(GPIO_PWC_PERMIT[ 4] & ~reg_be))) |
               (racl_addr_hit_write[ 5] & (|(GPIO_PWC_PERMIT[ 5] & ~reg_be))) |
               (racl_addr_hit_write[ 6] & (|(GPIO_PWC_PERMIT[ 6] & ~reg_be))) |
               (racl_addr_hit_write[ 7] & (|(GPIO_PWC_PERMIT[ 7] & ~reg_be))) |
               (racl_addr_hit_write[ 8] & (|(GPIO_PWC_PERMIT[ 8] & ~reg_be))) |
               (racl_addr_hit_write[ 9] & (|(GPIO_PWC_PERMIT[ 9] & ~reg_be))) |
               (racl_addr_hit_write[10] & (|(GPIO_PWC_PERMIT[10] & ~reg_be))) |
               (racl_addr_hit_write[11] & (|(GPIO_PWC_PERMIT[11] & ~reg_be))) |
               (racl_addr_hit_write[12] & (|(GPIO_PWC_PERMIT[12] & ~reg_be))) |
               (racl_addr_hit_write[13] & (|(GPIO_PWC_PERMIT[13] & ~reg_be))) |
               (racl_addr_hit_write[14] & (|(GPIO_PWC_PERMIT[14] & ~reg_be))) |
               (racl_addr_hit_write[15] & (|(GPIO_PWC_PERMIT[15] & ~reg_be))) |
               (racl_addr_hit_write[16] & (|(GPIO_PWC_PERMIT[16] & ~reg_be))) |
               (racl_addr_hit_write[17] & (|(GPIO_PWC_PERMIT[17] & ~reg_be)))));
  end
