...
package gpio_pwc_env_pkg;
  ...
  typedef virtual gpio_pwc_straps_if straps_vif;
  typedef class gpio_pwc_env_cfg;
  typedef class gpio_pwc_env_cov;
  typedef cip_base_virtual_sequencer #(gpio_pwc_env_cfg, gpio_pwc_env_cov) gpio_pwc_virtual_sequencer;
  ...
  // package sources
  `include "gpio_pwc_env_cfg.sv"
  `include "gpio_pwc_env_cov.sv"
  `include "gpio_pwc_scoreboard.sv"
  `include "gpio_pwc_env.sv"
  `include "gpio_pwc_vseq_list.sv"
endpackage
