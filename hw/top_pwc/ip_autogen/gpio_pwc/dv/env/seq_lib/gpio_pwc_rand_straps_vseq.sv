...
class gpio_pwc_rand_straps_vseq extends gpio_pwc_base_vseq;

  `uvm_object_utils(gpio_pwc_rand_straps_vseq)
  ...
  function new(string name = "gpio_pwc_rand_straps_vseq");
    super.new(name);
  endfunction
...
endclass : gpio_pwc_rand_straps_vseq
