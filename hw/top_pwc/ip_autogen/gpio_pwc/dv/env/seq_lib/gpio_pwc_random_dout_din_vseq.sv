...
// class : gpio_pwc_random_dout_din_vseq
...
class gpio_pwc_random_dout_din_vseq extends gpio_pwc_base_vseq;

  `uvm_object_utils(gpio_pwc_random_dout_din_vseq)
  `uvm_object_new
...
endclass : gpio_pwc_random_dout_din_vseq
