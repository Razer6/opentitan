...
// class : gpio_pwc_random_long_reg_writes_reg_reads_vseq
...
class gpio_pwc_random_long_reg_writes_reg_reads_vseq extends gpio_pwc_base_vseq;

  `uvm_object_utils(gpio_pwc_random_long_reg_writes_reg_reads_vseq)
  `uvm_object_new
...
endclass : gpio_pwc_random_long_reg_writes_reg_reads_vseq
