...
class gpio_pwc_base_vseq extends cip_base_vseq #(
        .CFG_T               (gpio_pwc_env_cfg),
        .RAL_T               (gpio_pwc_reg_block),
        .COV_T               (gpio_pwc_env_cov),
        .VIRTUAL_SEQUENCER_T (gpio_pwc_virtual_sequencer)
    );
  ...
  `uvm_object_utils(gpio_pwc_base_vseq)
  `uvm_object_new
