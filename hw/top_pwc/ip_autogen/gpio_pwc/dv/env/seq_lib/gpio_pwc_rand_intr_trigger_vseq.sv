...
// class : gpio_pwc_rand_intr_trigger_vseq
...
class gpio_pwc_rand_intr_trigger_vseq extends gpio_pwc_base_vseq;

  constraint num_trans_c {
    num_trans inside {[20:200]};
  }

  `uvm_object_utils(gpio_pwc_rand_intr_trigger_vseq)
  `uvm_object_new
...
endclass : gpio_pwc_rand_intr_trigger_vseq
