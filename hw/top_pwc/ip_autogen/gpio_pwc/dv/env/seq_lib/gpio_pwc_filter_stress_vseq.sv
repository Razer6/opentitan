...
// class : gpio_pwc_filter_stress_vseq
...
class gpio_pwc_filter_stress_vseq extends gpio_pwc_intr_with_filter_rand_intr_event_vseq;

  `uvm_object_utils(gpio_pwc_filter_stress_vseq)
  `uvm_object_new
