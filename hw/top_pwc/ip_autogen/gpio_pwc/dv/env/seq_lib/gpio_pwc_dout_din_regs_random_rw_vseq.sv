...
// class : gpio_pwc_dout_din_regs_random_rw_vseq
...
class gpio_pwc_dout_din_regs_random_rw_vseq extends gpio_pwc_base_vseq;

  `uvm_object_utils(gpio_pwc_dout_din_regs_random_rw_vseq)
  `uvm_object_new
...
endclass : gpio_pwc_dout_din_regs_random_rw_vseq
