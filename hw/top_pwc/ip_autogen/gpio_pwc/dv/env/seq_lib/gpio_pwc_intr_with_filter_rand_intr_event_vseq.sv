...
class gpio_pwc_intr_with_filter_rand_intr_event_vseq extends gpio_pwc_base_vseq;
  ...
  `uvm_object_utils(gpio_pwc_intr_with_filter_rand_intr_event_vseq)

  function new(string name = "gpio_pwc_intr_with_filter_rand_intr_event_vseq");
    super.new(name);
...
endclass : gpio_pwc_intr_with_filter_rand_intr_event_vseq
