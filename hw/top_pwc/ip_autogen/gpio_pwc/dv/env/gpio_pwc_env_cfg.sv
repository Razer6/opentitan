...
class gpio_pwc_env_cfg extends cip_base_env_cfg #(
  ...
  `uvm_object_utils(gpio_pwc_env_cfg)

  function new(string name = "gpio_pwc_env_cfg");
    super.new(name);
  endfunction

  virtual function void initialize(bit [TL_AW-1:0] csr_base_addr = '1);
    list_of_alerts = gpio_pwc_env_pkg::LIST_OF_ALERTS;
