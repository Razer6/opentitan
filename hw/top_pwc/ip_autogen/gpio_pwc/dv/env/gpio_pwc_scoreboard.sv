...
class gpio_pwc_scoreboard extends cip_base_scoreboard #(.CFG_T (gpio_pwc_env_cfg),
                                                    .RAL_T (gpio_pwc_reg_block),
                                                    .COV_T (gpio_pwc_env_cov));
  ...
  `uvm_component_utils(gpio_pwc_scoreboard)

  function new (string name = "gpio_pwc_scoreboard", uvm_component parent = null);
