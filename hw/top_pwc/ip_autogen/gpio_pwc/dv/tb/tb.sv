...
module tb;
  ...
  import dv_utils_pkg::*;
  import tl_agent_pkg::*;
  import gpio_pwc_env_pkg::*;
  import gpio_pwc_test_pkg::*;
  import gpio_pwc_reg_pkg::*;
  // macro includes
  ...
  gpio_pwc_straps_if straps_if_inst (
    .clk  (clk),
    .rst_n(rst_n)
  );
  tl_if tl_if (
...
`endif
  ...
  initial begin
    ...
    uvm_config_db#(virtual gpio_pwc_straps_if)::set(null, "*.*", "straps_vif", straps_if_inst);
