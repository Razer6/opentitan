...
module rv_plic_pwc import rv_plic_pwc_reg_pkg::*; #(
  ...
  rv_plic_pwc_reg2hw_t reg2hw;
  rv_plic_pwc_hw2reg_t hw2reg;
  ...
  // Glue logic between rv_plic_pwc_reg_top and others
  ...
  // Interrupt Enable //
  //////////////////////
  for (genvar s = 0; s < 253; s++) begin : gen_ie0
  ...
  // IP //
  ////////
  for (genvar s = 0; s < 253; s++) begin : gen_ip
