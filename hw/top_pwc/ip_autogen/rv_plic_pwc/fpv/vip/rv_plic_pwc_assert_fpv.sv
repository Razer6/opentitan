...
// Testbench module for rv_plic_pwc. Intended to use with a formal tool.

`include "prim_assert.sv"

module rv_plic_pwc_assert_fpv #(parameter int NumSrc = 1,
...
endmodule : rv_plic_pwc_assert_fpv
