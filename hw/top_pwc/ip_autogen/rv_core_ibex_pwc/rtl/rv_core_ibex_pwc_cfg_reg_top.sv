...
module rv_core_ibex_pwc_cfg_reg_top (
  ...
  always_comb begin
    ...
    addr_hit[ 3] = (reg_addr == RV_CORE_IBEX_PWC_IBUS_REGWEN_0_OFFSET);
    addr_hit[ 4] = (reg_addr == RV_CORE_IBEX_PWC_IBUS_REGWEN_1_OFFSET);
    addr_hit[ 5] = (reg_addr == RV_CORE_IBEX_PWC_IBUS_ADDR_EN_0_OFFSET);
    addr_hit[ 6] = (reg_addr == RV_CORE_IBEX_PWC_IBUS_ADDR_EN_1_OFFSET);
    addr_hit[ 7] = (reg_addr == RV_CORE_IBEX_PWC_IBUS_ADDR_MATCHING_0_OFFSET);
    addr_hit[ 8] = (reg_addr == RV_CORE_IBEX_PWC_IBUS_ADDR_MATCHING_1_OFFSET);
    addr_hit[ 9] = (reg_addr == RV_CORE_IBEX_PWC_IBUS_REMAP_ADDR_0_OFFSET);
    addr_hit[10] = (reg_addr == RV_CORE_IBEX_PWC_IBUS_REMAP_ADDR_1_OFFSET);
    addr_hit[11] = (reg_addr == RV_CORE_IBEX_PWC_DBUS_REGWEN_0_OFFSET);
    addr_hit[12] = (reg_addr == RV_CORE_IBEX_PWC_DBUS_REGWEN_1_OFFSET);
    addr_hit[13] = (reg_addr == RV_CORE_IBEX_PWC_DBUS_ADDR_EN_0_OFFSET);
    addr_hit[14] = (reg_addr == RV_CORE_IBEX_PWC_DBUS_ADDR_EN_1_OFFSET);
    addr_hit[15] = (reg_addr == RV_CORE_IBEX_PWC_DBUS_ADDR_MATCHING_0_OFFSET);
    addr_hit[16] = (reg_addr == RV_CORE_IBEX_PWC_DBUS_ADDR_MATCHING_1_OFFSET);
    addr_hit[17] = (reg_addr == RV_CORE_IBEX_PWC_DBUS_REMAP_ADDR_0_OFFSET);
    addr_hit[18] = (reg_addr == RV_CORE_IBEX_PWC_DBUS_REMAP_ADDR_1_OFFSET);
    addr_hit[19] = (reg_addr == RV_CORE_IBEX_PWC_NMI_ENABLE_OFFSET);
    addr_hit[20] = (reg_addr == RV_CORE_IBEX_PWC_NMI_STATE_OFFSET);
    addr_hit[21] = (reg_addr == RV_CORE_IBEX_PWC_ERR_STATUS_OFFSET);
