 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_PWC_SOC_MBX_RACL_CTRL_PWC_BASE_ADDR 0x1471F00u
 ...
 */
#define TOP_PWC_SOC_MBX_RACL_CTRL_PWC_SIZE_BYTES 0x100u
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_PWC_SOC_MBX_AC_RANGE_CHECK_PWC_BASE_ADDR 0x1474000u
 ...
 */
#define TOP_PWC_SOC_MBX_AC_RANGE_CHECK_PWC_SIZE_BYTES 0x400u
