 ...
 */
#define TOP_PWC_RV_CORE_IBEX_PWC_CFG_SIZE_BYTES 0x100u
...
typedef enum top_pwc_plic_irq_id {
  ...
  kTopPwcPlicIrqIdLast = 219, /**< \internal The Last Valid Interrupt ID. */
...
extern const top_pwc_plic_peripheral_t
    top_pwc_plic_interrupt_for_peripheral[220];
