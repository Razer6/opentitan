...
|                       |          |            |             |               |               | this correctly).                                                          |
|   ROT_CREATOR_AUTH    |    no    |     no     |     yes     | yes (Digest)  |   yes (CSR)   | Software managed RoT Creator partition.                                   |
| ROT_OWNER_AUTH_SLOT0  |    no    |     no     |     yes     | yes (Digest)  |   yes (CSR)   | Software managed RoT Owner slot 0 partition.                              |
