...
|:------:|:------:|:-------:|:------------------|:------------------------------------------------------------|
|   31   |        |         |                   | Reserved                                                    |
| 30:22  |   rw   |  0x40   | TSUR_PS_CS_CYCLES | number oscialltor clock cycles to satisfy TSUR_PS_CS timing |
| 21:12  |   rw   |  0x57   | TSUR_PS_CYCLES    | number oscialltor clock cycles to satisfy TSUR_PS timing    |
|  11:0  |   rw   |  0x147  | TSUR_PD_PS_CYCLES | number oscialltor clock cycles to satisfy TSUR_PD_PS timing |
...
|:------:|:------:|:-------:|:------------------|:------------------------------------------------------------|
| 31:29  |        |         |                   | Reserved                                                    |
| 28:19  |   rw   |  0x57   | TSQ_CYCLES        | number oscialltor clock cycles to satisfy TSQ timing        |
|  18:9  |   rw   |  0x57   | TSUP_PS_CYCLES    | number oscialltor clock cycles to satisfy TSUP_PS timing    |
|  8:0   |   rw   |  0x40   | TSUP_PS_CS_CYCLES | number oscialltor clock cycles to satisfy TSUP_PS_CS timing |
...
|  Bits  |  Type  |  Reset  | Name           | Description                                              |
|:------:|:------:|:-------:|:---------------|:---------------------------------------------------------|
| 31:25  |   rw   |  0x31   | TSUR_LD_CYCLES | number oscialltor clock cycles to satisfy TSUR_LD timing |
| 24:11  |   rw   |  0x753  | TPGM_CYCLES    | number oscialltor clock cycles to satisfy TPGM timing    |
|  10:0  |   rw   |  0xda   | TSQ_M_CYCLES   | number oscialltor clock cycles to satisfy TSQ_M timing   |
...
|:------:|:------:|:-------:|:--------------|:--------------------------------------------------------|
| 31:29  |        |         |               | Reserved                                                |
| 28:20  |   rw   |  0x2a   | THP_CS_CYCLES | number oscialltor clock cycles to satisfy THP_CS timing |
| 19:10  |   rw   |  0x5e   | THP_PS_CYCLES | number oscialltor clock cycles to satisfy THP_PS timing |
|  9:0   |   rw   |  0x5e   | THR_PS_CYCLES | number oscialltor clock cycles to satisfy THR_PS timing |
...
|:------:|:------:|:-------:|:-----------------|:-----------------------------------------------------------|
| 31:27  |        |         |                  | Reserved                                                   |
| 26:18  |   rw   |  0x35   | THR_PS_CS_CYCLES | number oscialltor clock cycles to satisfy THR_PS_CS timing |
|  17:9  |   rw   |  0x35   | THP_PS_CS_CYCLES | number oscialltor clock cycles to satisfy THP_PS_CS timing |
|  8:0   |   rw   |  0x2a   | THR_CS_CYCLES    | number oscialltor clock cycles to satisfy THR_CS timing    |
...
|  Bits  |  Type  |  Reset  | Name           | Description                                              |
|:------:|:------:|:-------:|:---------------|:---------------------------------------------------------|
| 31:24  |   rw   |  0x31   | TSUP_LD_CYCLES | number oscialltor clock cycles to satisfy TSUP_LD timing |
| 23:16  |   rw   |   0xf   | THP_A_CYCLES   | number oscialltor clock cycles to satisfy THP_A timing   |
|  15:8  |   rw   |   0xf   | TSUP_A_CYCLES  | number oscialltor clock cycles to satisfy TSUP_A timing  |
|  7:0   |   rw   |   0xf   | TSUR_A_CYCLES  | number oscialltor clock cycles to satisfy TSUR_A timing  |
...
|:------:|:------:|:-------:|:-------------|:-------------------------------------------------------|
| 31:29  |        |         |              | Reserved                                               |
| 28:21  |   rw   |  0x13   | THR_A_CYCLES | number oscialltor clock cycles to satisfy THR_A timing |
| 20:10  |   rw   |  0xda   | TRD_M_CYCLES | number oscialltor clock cycles to satisfy TRD_M timing |
|  9:0   |   rw   |  0x5a   | TRD_CYCLES   | number oscialltor clock cycles to satisfy TRD timing   |
...
|:------:|:------:|:-------:|:--------------------|:--------------------------------------------------------------|
| 31:24  |        |         |                     | Reserved                                                      |
| 23:16  |   rw   |   0x1   | ADDR_CAPTURE_CYCLES | number oscialltor clock cycles to satisfy ADDR_CAPTURE timing |
|  15:8  |   rw   |   0x1   | DATA_CAPTURE_CYCLES | number oscialltor clock cycles to satisfy DATA_CAPTURE timing |
|  7:0   |   rw   |  0x1b   | THP_PD_PS_CYCLES    | number oscialltor clock cycles to satisfy THP_PD_PS timing    |
...
|:------:|:------:|:-------:|:--------------------------|:--------------------------------------------------------------------|
| 31:18  |        |         |                           | Reserved                                                            |
|  17:0  |   rw   | 0x493e  | TRIGGER_POWER_DOWN_CYCLES | number oscialltor clock cycles to satisfy TRIGGER_POWER_DOWN timing |
...
|:------:|:------:|:-------:|:------------------|:------------------------------------------------------------|
|   31   |        |         |                   | Reserved                                                    |
| 30:22  |   rw   |  0x11   | TSUR_PS_CS_CYCLES | number oscialltor clock cycles to satisfy TSUR_PS_CS timing |
| 21:12  |   rw   |  0x17   | TSUR_PS_CYCLES    | number oscialltor clock cycles to satisfy TSUR_PS timing    |
|  11:0  |   rw   |  0x57   | TSUR_PD_PS_CYCLES | number oscialltor clock cycles to satisfy TSUR_PD_PS timing |
...
|:------:|:------:|:-------:|:------------------|:------------------------------------------------------------|
| 31:29  |        |         |                   | Reserved                                                    |
| 28:19  |   rw   |  0x17   | TSQ_CYCLES        | number oscialltor clock cycles to satisfy TSQ timing        |
|  18:9  |   rw   |  0x17   | TSUP_PS_CYCLES    | number oscialltor clock cycles to satisfy TSUP_PS timing    |
|  8:0   |   rw   |  0x11   | TSUP_PS_CS_CYCLES | number oscialltor clock cycles to satisfy TSUP_PS_CS timing |
...
|  Bits  |  Type  |  Reset  | Name           | Description                                              |
|:------:|:------:|:-------:|:---------------|:---------------------------------------------------------|
| 31:25  |   rw   |   0xd   | TSUR_LD_CYCLES | number oscialltor clock cycles to satisfy TSUR_LD timing |
| 24:11  |   rw   |  0x1f4  | TPGM_CYCLES    | number oscialltor clock cycles to satisfy TPGM timing    |
|  10:0  |   rw   |  0x3a   | TSQ_M_CYCLES   | number oscialltor clock cycles to satisfy TSQ_M timing   |
...
|:------:|:------:|:-------:|:--------------|:--------------------------------------------------------|
| 31:29  |        |         |               | Reserved                                                |
| 28:20  |   rw   |   0xb   | THP_CS_CYCLES | number oscialltor clock cycles to satisfy THP_CS timing |
| 19:10  |   rw   |  0x19   | THP_PS_CYCLES | number oscialltor clock cycles to satisfy THP_PS timing |
|  9:0   |   rw   |  0x19   | THR_PS_CYCLES | number oscialltor clock cycles to satisfy THR_PS timing |
...
|:------:|:------:|:-------:|:-----------------|:-----------------------------------------------------------|
| 31:27  |        |         |                  | Reserved                                                   |
| 26:18  |   rw   |   0xe   | THR_PS_CS_CYCLES | number oscialltor clock cycles to satisfy THR_PS_CS timing |
|  17:9  |   rw   |   0xe   | THP_PS_CS_CYCLES | number oscialltor clock cycles to satisfy THP_PS_CS timing |
|  8:0   |   rw   |   0xb   | THR_CS_CYCLES    | number oscialltor clock cycles to satisfy THR_CS timing    |
...
|  Bits  |  Type  |  Reset  | Name           | Description                                              |
|:------:|:------:|:-------:|:---------------|:---------------------------------------------------------|
| 31:24  |   rw   |   0xd   | TSUP_LD_CYCLES | number oscialltor clock cycles to satisfy TSUP_LD timing |
| 23:16  |   rw   |   0x5   | THP_A_CYCLES   | number oscialltor clock cycles to satisfy THP_A timing   |
|  15:8  |   rw   |   0x4   | TSUP_A_CYCLES  | number oscialltor clock cycles to satisfy TSUP_A timing  |
|  7:0   |   rw   |   0x4   | TSUR_A_CYCLES  | number oscialltor clock cycles to satisfy TSUR_A timing  |
...
|:------:|:------:|:-------:|:-------------|:-------------------------------------------------------|
| 31:29  |        |         |              | Reserved                                               |
| 28:21  |   rw   |   0x5   | THR_A_CYCLES | number oscialltor clock cycles to satisfy THR_A timing |
| 20:10  |   rw   |  0x3a   | TRD_M_CYCLES | number oscialltor clock cycles to satisfy TRD_M timing |
|  9:0   |   rw   |  0x1b   | TRD_CYCLES   | number oscialltor clock cycles to satisfy TRD timing   |
...
| 23:16  |   rw   |   0x1   | ADDR_CAPTURE_CYCLES | number oscialltor clock cycles to satisfy ADDR_CAPTURE timing |
|  15:8  |   rw   |   0x1   | DATA_CAPTURE_CYCLES | number oscialltor clock cycles to satisfy DATA_CAPTURE timing |
|  7:0   |   rw   |   0x7   | THP_PD_PS_CYCLES    | number oscialltor clock cycles to satisfy THP_PD_PS timing    |
...
|:------:|:------:|:-------:|:--------------------------|:--------------------------------------------------------------------|
| 31:18  |        |         |                           | Reserved                                                            |
|  17:0  |   rw   | 0x1388  | TRIGGER_POWER_DOWN_CYCLES | number oscialltor clock cycles to satisfy TRIGGER_POWER_DOWN timing |
