...
module otp_ctrl_core_reg_top (
  ...
  //   F[reset_allowed]: 31:31
  prim_subreg_ext #(
    .DW    (1)
  ) u_status_reset_allowed (
    .re     (status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.status.reset_allowed.d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (status_reset_allowed_qs)
  );
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[4]: begin
        ...
        reg_rdata_next[31] = status_reset_allowed_qs;
      end
