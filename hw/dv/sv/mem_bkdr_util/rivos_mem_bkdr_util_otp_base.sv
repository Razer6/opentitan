...
class rivos_mem_bkdr_util_otp_base extends uvm_object;
...
//[RVSCS]      `DV_CHECK_FATAL(non_ecc_bits_per_subword < this.width)
...
//[RVSCS]      `DV_CHECK_FATAL((this.width < bits_per_subword) || (this.width % bits_per_subword == 0),
//[RVSCS]                      "With multiple subwords, mem width must be a multiple of the ECC width")
...
//RVSCS    `DV_CHECK_LE_FATAL(bytes_per_word, 32, "data width > 32 bytes is not supported")
