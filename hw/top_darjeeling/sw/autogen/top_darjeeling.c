...
const top_darjeeling_alert_peripheral_t
  ...
  [kTopDarjeelingAlertIdIncomingMioRvTimerFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioAonTimerAonFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioSramCtrlRetAonFatalError] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioRvDmFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioRvPlicMioFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioSramCtrlMainFatalError] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioSramCtrlMboxFatalError] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioDmaFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioMbx0FatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioMbx0RecovFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioMbx1FatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioMbx1RecovFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioMbx2FatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioMbx2RecovFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioMbx3FatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioMbx3RecovFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioMbx4FatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioMbx4RecovFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioMbx5FatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioMbx5RecovFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioMbxPcie0FatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioMbxPcie0RecovFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioRaclCtrlMioFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioRaclCtrlMioRecovCtrlUpdateErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioAcRangeCheckMioRecovCtrlUpdateErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioAcRangeCheckMioFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioRvCoreIbexMioFatalSwErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioRvCoreIbexMioRecovSwErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioRvCoreIbexMioFatalHwErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioRvCoreIbexMioRecovHwErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcGpioFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcRvTimerFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcAonTimerAonFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcSramCtrlRetAonFatalError] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcRvDmFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcRvPlicPwcFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcSramCtrlMainFatalError] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcSramCtrlMboxFatalError] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcDmaFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcMbx0FatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcMbx0RecovFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcMbx1FatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcMbx1RecovFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcMbx2FatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcMbx2RecovFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcMbx3FatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcMbx3RecovFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcMbx4FatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcMbx4RecovFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcMbx5FatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcMbx5RecovFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcMbxPcie0FatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcMbxPcie0RecovFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcRaclCtrlPwcFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcRaclCtrlPwcRecovCtrlUpdateErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcAcRangeCheckPwcRecovCtrlUpdateErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcAcRangeCheckPwcFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcRvCoreIbexPwcFatalSwErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcRvCoreIbexPwcRecovSwErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcRvCoreIbexPwcFatalHwErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcRvCoreIbexPwcRecovHwErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingMioExtraAlertsIntegErrorScsmio] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingPwcExtraAlertsIntegErrorScsmio] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsAmsIpWrapperIntegError] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsAmsIpWrapperCsrngRecov] = kTopDarjeelingAlertPeripheralExternal,
  ...
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsRasCtlResetAlert] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsScsRaiAlertTrigger] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupAEscErr0] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupAEscErr1] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupAEscErr2] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupAEscErr3] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupBEscErr0] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupBEscErr1] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupBEscErr2] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupBEscErr3] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupCEscErr0] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupCEscErr1] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupCEscErr2] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupCEscErr3] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupDEscErr0] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupDEscErr1] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupDEscErr2] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupDEscErr3] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupATimerRstReq] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupBTimerRstReq] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupCTimerRstReq] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingRotExtraAlertsLsioGroupDTimerRstReq] = kTopDarjeelingAlertPeripheralExternal,
  ...
  [kTopDarjeelingAlertIdIncomingOtherExtraAlertsScsifregsRaclCtrlFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingOtherExtraAlertsScsifregsRaclCtrlRecovCtrlUpdateErr] = kTopDarjeelingAlertPeripheralExternal,
  ...
  [kTopDarjeelingAlertIdIncomingOtherExtraAlertsNsgrpRaclCtrlFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingOtherExtraAlertsNsgrpRaclCtrlRecovCtrlUpdateErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingOtherExtraAlertsNsefuseBusIntegErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingOtherExtraAlertsNsefusePrimFatalErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingOtherExtraAlertsNsefusePrimRecovErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingOtherExtraAlertsNsefuseApbAdapterIntegErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingOtherExtraAlertsLioGroupVRaclCtrlFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingOtherExtraAlertsLioGroupVRaclCtrlRecovCtrlUpdateErr] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingOtherExtraAlertsLioGroupVIntegError] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingOtherExtraAlertsLioGroupPRaclCtrlFatalFault] = kTopDarjeelingAlertPeripheralExternal,
  [kTopDarjeelingAlertIdIncomingOtherExtraAlertsLioGroupPRaclCtrlRecovCtrlUpdateErr] = kTopDarjeelingAlertPeripheralExternal,
...
const top_darjeeling_plic_peripheral_t
  ...
  [kTopDarjeelingPlicIrqIdScsifregsRaclError] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdNsgrpRaclError] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpVRaclError] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpPRaclError] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpDRaclError] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpCRaclError] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpBRaclError] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpARaclError] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpAAlerthandlerClassA] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpAAlerthandlerClassB] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpAAlerthandlerClassC] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpAAlerthandlerClassD] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpBAlerthandlerClassA] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpBAlerthandlerClassB] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpBAlerthandlerClassC] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpBAlerthandlerClassD] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpCAlerthandlerClassA] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpCAlerthandlerClassB] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpCAlerthandlerClassC] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpCAlerthandlerClassD] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpDAlerthandlerClassA] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpDAlerthandlerClassB] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpDAlerthandlerClassC] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdLioGrpDAlerthandlerClassD] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdScsctnif0AcRangeCtnDenyCntReached] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdScsctnif0AcRangeBcastDenyCntReached] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdScsctnif1AcRangeCtnDenyCntReached] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdNsgrpNsefuseProgError] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdRaclCtrlMioRaclCtrlMioRaclError] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdAcRangeCheckMioAcRangeCheckMioDenyCntReached] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdRaclCtrlPwcRaclCtrlPwcRaclError] = kTopDarjeelingPlicPeripheralUnknown,
  [kTopDarjeelingPlicIrqIdAcRangeCheckPwcAcRangeCheckPwcDenyCntReached] = kTopDarjeelingPlicPeripheralUnknown,
};
