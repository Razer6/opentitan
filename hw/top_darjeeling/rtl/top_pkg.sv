...
// Rivos change TL_AIW(8) -> 16
// To accomodate the large number of hosts in SCS
// TL_DIW(1) -> 16
// FIXME: We probably can change that back to 1 as OT only passes that through code
localparam int TL_AIW=16;    // a_source, d_source
localparam int TL_DIW=16;    // d_sink
...
// Set to 3 to accomodate for random delays in synchronizer stages used on the alert signals
