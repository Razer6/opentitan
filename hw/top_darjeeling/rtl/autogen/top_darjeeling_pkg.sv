...
package top_darjeeling_pkg;
  ...
  */
  ...
  typedef enum int unsigned {
    ...
    TopDarjeelingIrqIdRasCtrlIbexIrq = 170,
    TopDarjeelingIrqIdAmsRefClkSlow = 171,
    TopDarjeelingIrqIdAmsRefClkFast = 172,
    TopDarjeelingIrqIdAmsAvgsGlitch = 173,
    TopDarjeelingIrqIdScsifregsRaclError = 174,
    TopDarjeelingIrqIdNsgrpRaclError = 175,
    TopDarjeelingIrqIdLioGrpVRaclError = 176,
    TopDarjeelingIrqIdLioGrpPRaclError = 177,
    TopDarjeelingIrqIdLioGrpDRaclError = 178,
    TopDarjeelingIrqIdLioGrpCRaclError = 179,
    TopDarjeelingIrqIdLioGrpBRaclError = 180,
  ...
  typedef enum int unsigned {
    ...
    TopDarjeelingIncomingIrqRotExternalIdRasCtrlIbexIrq = 10,
    TopDarjeelingIncomingIrqRotExternalIdAmsRefClkSlow = 11,
    TopDarjeelingIncomingIrqRotExternalIdAmsRefClkFast = 12,
    TopDarjeelingIncomingIrqRotExternalIdAmsAvgsGlitch = 13,
    TopDarjeelingIncomingIrqRotExternalIdScsifregsRaclError = 14,
    TopDarjeelingIncomingIrqRotExternalIdNsgrpRaclError = 15,
    TopDarjeelingIncomingIrqRotExternalIdLioGrpVRaclError = 16,
    TopDarjeelingIncomingIrqRotExternalIdLioGrpPRaclError = 17,
    TopDarjeelingIncomingIrqRotExternalIdLioGrpDRaclError = 18,
    TopDarjeelingIncomingIrqRotExternalIdLioGrpCRaclError = 19,
    TopDarjeelingIncomingIrqRotExternalIdLioGrpBRaclError = 20,
