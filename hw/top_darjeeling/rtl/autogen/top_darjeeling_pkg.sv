...
package top_darjeeling_pkg;
   ...
   */
  parameter int unsigned TOP_DARJEELING_OTP_MACRO_PRIM_SIZE_BYTES = 32'h80;
  ...
  */
  ...
  typedef enum int unsigned {
    ...
    TopDarjeelingPlicIrqIdRotHdrIpiFromDuc = 132,
    TopDarjeelingPlicIrqIdRotHdrIpiFromMio = 133,
    TopDarjeelingPlicIrqIdRotHdrIpiFromPwc = 134,
    TopDarjeelingPlicIrqIdRotHdrIpiFromRot2 = 135,
    TopDarjeelingPlicIrqIdRotHdrIpiFromRot1 = 136,
    TopDarjeelingPlicIrqIdRotHdrIpiFromRot0 = 137,
    TopDarjeelingPlicIrqIdLioGrpCIbexIrq = 138,
    TopDarjeelingPlicIrqIdLioGrpBIbexIrq = 139,
    TopDarjeelingPlicIrqIdLioGrpAIbexIrq = 140,
    TopDarjeelingPlicIrqIdRasCtrlErrorIrq = 141,
    TopDarjeelingPlicIrqIdAmsRefClkSlow = 142,
    TopDarjeelingPlicIrqIdAmsRefClkFast = 143,
    TopDarjeelingPlicIrqIdAmsAvgsGlitch = 144,
    TopDarjeelingPlicIrqIdScsifregsRaclError = 145,
    TopDarjeelingPlicIrqIdNsgrpRaclError = 146,
    TopDarjeelingPlicIrqIdLioGrpVRaclError = 147,
    TopDarjeelingPlicIrqIdLioGrpPRaclError = 148,
    TopDarjeelingPlicIrqIdLioGrpDRaclError = 149,
    TopDarjeelingPlicIrqIdLioGrpCRaclError = 150,
    TopDarjeelingPlicIrqIdLioGrpBRaclError = 151,
    TopDarjeelingPlicIrqIdLioGrpARaclError = 152,
    TopDarjeelingPlicIrqIdLioGrpAAlerthandlerClassA = 153,
    TopDarjeelingPlicIrqIdLioGrpAAlerthandlerClassB = 154,
    TopDarjeelingPlicIrqIdLioGrpAAlerthandlerClassC = 155,
    TopDarjeelingPlicIrqIdLioGrpAAlerthandlerClassD = 156,
    TopDarjeelingPlicIrqIdLioGrpBAlerthandlerClassA = 157,
    TopDarjeelingPlicIrqIdLioGrpBAlerthandlerClassB = 158,
    TopDarjeelingPlicIrqIdLioGrpBAlerthandlerClassC = 159,
    TopDarjeelingPlicIrqIdLioGrpBAlerthandlerClassD = 160,
    TopDarjeelingPlicIrqIdLioGrpCAlerthandlerClassA = 161,
    TopDarjeelingPlicIrqIdLioGrpCAlerthandlerClassB = 162,
    TopDarjeelingPlicIrqIdLioGrpCAlerthandlerClassC = 163,
    TopDarjeelingPlicIrqIdLioGrpCAlerthandlerClassD = 164,
    TopDarjeelingPlicIrqIdLioGrpDAlerthandlerClassA = 165,
    TopDarjeelingPlicIrqIdLioGrpDAlerthandlerClassB = 166,
    TopDarjeelingPlicIrqIdLioGrpDAlerthandlerClassC = 167,
    TopDarjeelingPlicIrqIdLioGrpDAlerthandlerClassD = 168,
    TopDarjeelingPlicIrqIdScsctnif0AcRangeCtnDenyCntReached = 169,
    TopDarjeelingPlicIrqIdScsctnif0AcRangeBcastDenyCntReached = 170,
    TopDarjeelingPlicIrqIdScsctnif1AcRangeCtnDenyCntReached = 171,
    TopDarjeelingPlicIrqIdNsgrpNsefuseProgError = 172,
    TopDarjeelingPlicIrqIdRaclCtrlMioRaclCtrlMioRaclError = 173,
    TopDarjeelingPlicIrqIdAcRangeCheckMioAcRangeCheckMioDenyCntReached = 174,
    TopDarjeelingPlicIrqIdRaclCtrlPwcRaclCtrlPwcRaclError = 175,
    TopDarjeelingPlicIrqIdAcRangeCheckPwcAcRangeCheckPwcDenyCntReached = 176,
    TopDarjeelingPlicIrqIdCount
  } interrupt_rv_plic_id_e;


  // Number of rot_external incoming interrupts
  parameter int unsigned NIncomingInterruptsRotExternal = 41;
  ...
  typedef enum int unsigned {
    ...
    TopDarjeelingIncomingIrqRotExternalIdNsgrpNsefuseProgError = 40,
