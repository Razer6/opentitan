...
package top_darjeeling_racl_pkg;
  ...
  parameter racl_policy_sel_t RACL_POLICY_SEL_VEC_MBX6_SOC [4] = '{
    RACL_POLICY_SEL_RCODE_PRIVATE_POLICY,        // 0 SOC_CONTROL           : Policy Idx  5
    RACL_POLICY_SEL_RCODE_PRIVATE_POLICY,        // 1 SOC_STATUS            : Policy Idx  5
    RACL_POLICY_SEL_RCODE_PRIVATE_POLICY,        // 2 SOC_DOE_INTR_MSG_ADDR : Policy Idx  5
    RACL_POLICY_SEL_RCODE_PRIVATE_POLICY         // 3 SOC_DOE_INTR_MSG_DATA : Policy Idx  5
  };
  parameter racl_policy_sel_t RACL_POLICY_SEL_WIN_MBX6_SOC_WDATA =
    RACL_POLICY_SEL_RCODE_PRIVATE_POLICY;        // Policy Idx  5
  ...
  parameter racl_policy_sel_t RACL_POLICY_SEL_VEC_MBX_PCIE1_SOC [4] = '{
    RACL_POLICY_SEL_POST_BOOT_M_POLICY,          // 0 SOC_CONTROL           : Policy Idx  3
    RACL_POLICY_SEL_POST_BOOT_M_POLICY,          // 1 SOC_STATUS            : Policy Idx  3
    RACL_POLICY_SEL_POST_BOOT_M_POLICY,          // 2 SOC_DOE_INTR_MSG_ADDR : Policy Idx  3
    RACL_POLICY_SEL_POST_BOOT_M_POLICY           // 3 SOC_DOE_INTR_MSG_DATA : Policy Idx  3
  };
  parameter racl_policy_sel_t RACL_POLICY_SEL_WIN_MBX_PCIE1_SOC_WDATA =
    RACL_POLICY_SEL_POST_BOOT_M_POLICY;          // Policy Idx  3
