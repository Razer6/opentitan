...
package racl_ctrl_reg_pkg;
  ...
  typedef enum int {
    ...
    RACL_CTRL_POLICY_POST_BOOT_M_POLICY_SHADOWED,
    RACL_CTRL_POLICY_TEE_LIMITED_POLICY_SHADOWED,
    RACL_CTRL_POLICY_RCODE_PRIVATE_POLICY_SHADOWED,
  ...
  parameter logic [3:0] RACL_CTRL_PERMIT [16] = '{
    ...
    4'b 0001, // index[10] RACL_CTRL_INTR_STATE
