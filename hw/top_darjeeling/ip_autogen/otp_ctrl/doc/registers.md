...
| otp_ctrl.[`DIRECT_ACCESS_REGWEN`](#direct_access_regwen)                       | 0x8c     |        4 | Register write enable for all direct access interface registers.                                                                           |
| otp_ctrl.[`DIRECT_ACCESS_CMD`](#direct_access_cmd)                             | 0x90     |        4 | Command register for direct accesses.                                                                                                      |
| otp_ctrl.[`DIRECT_ACCESS_ADDRESS`](#direct_access_address)                     | 0x94     |        4 | Address register for direct accesses.                                                                                                      |
| otp_ctrl.[`DIRECT_ACCESS_WDATA_0`](#direct_access_wdata)                       | 0x98     |        4 | Write data for direct accesses.                                                                                                            |
| otp_ctrl.[`DIRECT_ACCESS_WDATA_1`](#direct_access_wdata)                       | 0x9c     |        4 | Write data for direct accesses.                                                                                                            |
| otp_ctrl.[`DIRECT_ACCESS_RDATA_0`](#direct_access_rdata)                       | 0xa0     |        4 | Read data for direct accesses.                                                                                                             |
| otp_ctrl.[`DIRECT_ACCESS_RDATA_1`](#direct_access_rdata)                       | 0xa4     |        4 | Read data for direct accesses.                                                                                                             |
| otp_ctrl.[`CHECK_TRIGGER_REGWEN`](#check_trigger_regwen)                       | 0xa8     |        4 | Register write enable for [`CHECK_TRIGGER.`](#check_trigger)                                                                               |
| otp_ctrl.[`CHECK_TRIGGER`](#check_trigger)                                     | 0xac     |        4 | Command register for direct accesses.                                                                                                      |
| otp_ctrl.[`CHECK_REGWEN`](#check_regwen)                                       | 0xb0     |        4 | Register write enable for [`INTEGRITY_CHECK_PERIOD`](#integrity_check_period) and [`CONSISTENCY_CHECK_PERIOD.`](#consistency_check_period) |
| otp_ctrl.[`CHECK_TIMEOUT`](#check_timeout)                                     | 0xb4     |        4 | Timeout value for the integrity and consistency checks.                                                                                    |
| otp_ctrl.[`INTEGRITY_CHECK_PERIOD`](#integrity_check_period)                   | 0xb8     |        4 | This value specifies the maximum period that can be generated pseudo-randomly.                                                             |
| otp_ctrl.[`CONSISTENCY_CHECK_PERIOD`](#consistency_check_period)               | 0xbc     |        4 | This value specifies the maximum period that can be generated pseudo-randomly.                                                             |
| otp_ctrl.[`VENDOR_TEST_READ_LOCK`](#vendor_test_read_lock)                     | 0xc0     |        4 | Runtime read lock for the VENDOR_TEST partition.                                                                                           |
| otp_ctrl.[`CREATOR_SW_CFG_READ_LOCK`](#creator_sw_cfg_read_lock)               | 0xc4     |        4 | Runtime read lock for the CREATOR_SW_CFG partition.                                                                                        |
| otp_ctrl.[`OWNER_SW_CFG_READ_LOCK`](#owner_sw_cfg_read_lock)                   | 0xc8     |        4 | Runtime read lock for the OWNER_SW_CFG partition.                                                                                          |
| otp_ctrl.[`OWNERSHIP_SLOT_STATE_READ_LOCK`](#ownership_slot_state_read_lock)   | 0xcc     |        4 | Runtime read lock for the OWNERSHIP_SLOT_STATE partition.                                                                                  |
| otp_ctrl.[`ROT_CREATOR_IDENTITY_READ_LOCK`](#rot_creator_identity_read_lock)   | 0xd0     |        4 | Runtime read lock for the ROT_CREATOR_IDENTITY partition.                                                                                  |
| otp_ctrl.[`ROT_OWNER_AUTH_SLOT0_READ_LOCK`](#rot_owner_auth_slot0_read_lock)   | 0xd4     |        4 | Runtime read lock for the ROT_OWNER_AUTH_SLOT0 partition.                                                                                  |
| otp_ctrl.[`ROT_OWNER_AUTH_SLOT1_READ_LOCK`](#rot_owner_auth_slot1_read_lock)   | 0xd8     |        4 | Runtime read lock for the ROT_OWNER_AUTH_SLOT1 partition.                                                                                  |
| otp_ctrl.[`PLAT_INTEG_AUTH_SLOT0_READ_LOCK`](#plat_integ_auth_slot0_read_lock) | 0xdc     |        4 | Runtime read lock for the PLAT_INTEG_AUTH_SLOT0 partition.                                                                                 |
| otp_ctrl.[`PLAT_INTEG_AUTH_SLOT1_READ_LOCK`](#plat_integ_auth_slot1_read_lock) | 0xe0     |        4 | Runtime read lock for the PLAT_INTEG_AUTH_SLOT1 partition.                                                                                 |
| otp_ctrl.[`PLAT_OWNER_AUTH_SLOT0_READ_LOCK`](#plat_owner_auth_slot0_read_lock) | 0xe4     |        4 | Runtime read lock for the PLAT_OWNER_AUTH_SLOT0 partition.                                                                                 |
| otp_ctrl.[`PLAT_OWNER_AUTH_SLOT1_READ_LOCK`](#plat_owner_auth_slot1_read_lock) | 0xe8     |        4 | Runtime read lock for the PLAT_OWNER_AUTH_SLOT1 partition.                                                                                 |
| otp_ctrl.[`PLAT_OWNER_AUTH_SLOT2_READ_LOCK`](#plat_owner_auth_slot2_read_lock) | 0xec     |        4 | Runtime read lock for the PLAT_OWNER_AUTH_SLOT2 partition.                                                                                 |
| otp_ctrl.[`PLAT_OWNER_AUTH_SLOT3_READ_LOCK`](#plat_owner_auth_slot3_read_lock) | 0xf0     |        4 | Runtime read lock for the PLAT_OWNER_AUTH_SLOT3 partition.                                                                                 |
| otp_ctrl.[`EXT_NVM_READ_LOCK`](#ext_nvm_read_lock)                             | 0xf4     |        4 | Runtime read lock for the EXT_NVM partition.                                                                                               |
| otp_ctrl.[`ROM_PATCH_READ_LOCK`](#rom_patch_read_lock)                         | 0xf8     |        4 | Runtime read lock for the ROM_PATCH partition.                                                                                             |
| otp_ctrl.[`SOC_FUSES_CP_READ_LOCK`](#soc_fuses_cp_read_lock)                   | 0xfc     |        4 | Runtime read lock for the SOC_FUSES_CP partition.                                                                                          |
| otp_ctrl.[`SOC_FUSES_FT_READ_LOCK`](#soc_fuses_ft_read_lock)                   | 0x100    |        4 | Runtime read lock for the SOC_FUSES_FT partition.                                                                                          |
| otp_ctrl.[`SCRATCH_FUSES_READ_LOCK`](#scratch_fuses_read_lock)                 | 0x104    |        4 | Runtime read lock for the SCRATCH_FUSES partition.                                                                                         |
| otp_ctrl.[`VENDOR_TEST_DIGEST_0`](#vendor_test_digest)                         | 0x108    |        4 | Integrity digest for the VENDOR_TEST partition.                                                                                            |
| otp_ctrl.[`VENDOR_TEST_DIGEST_1`](#vendor_test_digest)                         | 0x10c    |        4 | Integrity digest for the VENDOR_TEST partition.                                                                                            |
| otp_ctrl.[`CREATOR_SW_CFG_DIGEST_0`](#creator_sw_cfg_digest)                   | 0x110    |        4 | Integrity digest for the CREATOR_SW_CFG partition.                                                                                         |
| otp_ctrl.[`CREATOR_SW_CFG_DIGEST_1`](#creator_sw_cfg_digest)                   | 0x114    |        4 | Integrity digest for the CREATOR_SW_CFG partition.                                                                                         |
| otp_ctrl.[`OWNER_SW_CFG_DIGEST_0`](#owner_sw_cfg_digest)                       | 0x118    |        4 | Integrity digest for the OWNER_SW_CFG partition.                                                                                           |
| otp_ctrl.[`OWNER_SW_CFG_DIGEST_1`](#owner_sw_cfg_digest)                       | 0x11c    |        4 | Integrity digest for the OWNER_SW_CFG partition.                                                                                           |
| otp_ctrl.[`ROT_CREATOR_IDENTITY_DIGEST_0`](#rot_creator_identity_digest)       | 0x120    |        4 | Integrity digest for the ROT_CREATOR_IDENTITY partition.                                                                                   |
| otp_ctrl.[`ROT_CREATOR_IDENTITY_DIGEST_1`](#rot_creator_identity_digest)       | 0x124    |        4 | Integrity digest for the ROT_CREATOR_IDENTITY partition.                                                                                   |
| otp_ctrl.[`ROT_OWNER_AUTH_SLOT0_DIGEST_0`](#rot_owner_auth_slot0_digest)       | 0x128    |        4 | Integrity digest for the ROT_OWNER_AUTH_SLOT0 partition.                                                                                   |
| otp_ctrl.[`ROT_OWNER_AUTH_SLOT0_DIGEST_1`](#rot_owner_auth_slot0_digest)       | 0x12c    |        4 | Integrity digest for the ROT_OWNER_AUTH_SLOT0 partition.                                                                                   |
| otp_ctrl.[`ROT_OWNER_AUTH_SLOT1_DIGEST_0`](#rot_owner_auth_slot1_digest)       | 0x130    |        4 | Integrity digest for the ROT_OWNER_AUTH_SLOT1 partition.                                                                                   |
| otp_ctrl.[`ROT_OWNER_AUTH_SLOT1_DIGEST_1`](#rot_owner_auth_slot1_digest)       | 0x134    |        4 | Integrity digest for the ROT_OWNER_AUTH_SLOT1 partition.                                                                                   |
| otp_ctrl.[`PLAT_INTEG_AUTH_SLOT0_DIGEST_0`](#plat_integ_auth_slot0_digest)     | 0x138    |        4 | Integrity digest for the PLAT_INTEG_AUTH_SLOT0 partition.                                                                                  |
| otp_ctrl.[`PLAT_INTEG_AUTH_SLOT0_DIGEST_1`](#plat_integ_auth_slot0_digest)     | 0x13c    |        4 | Integrity digest for the PLAT_INTEG_AUTH_SLOT0 partition.                                                                                  |
| otp_ctrl.[`PLAT_INTEG_AUTH_SLOT1_DIGEST_0`](#plat_integ_auth_slot1_digest)     | 0x140    |        4 | Integrity digest for the PLAT_INTEG_AUTH_SLOT1 partition.                                                                                  |
| otp_ctrl.[`PLAT_INTEG_AUTH_SLOT1_DIGEST_1`](#plat_integ_auth_slot1_digest)     | 0x144    |        4 | Integrity digest for the PLAT_INTEG_AUTH_SLOT1 partition.                                                                                  |
| otp_ctrl.[`PLAT_OWNER_AUTH_SLOT0_DIGEST_0`](#plat_owner_auth_slot0_digest)     | 0x148    |        4 | Integrity digest for the PLAT_OWNER_AUTH_SLOT0 partition.                                                                                  |
| otp_ctrl.[`PLAT_OWNER_AUTH_SLOT0_DIGEST_1`](#plat_owner_auth_slot0_digest)     | 0x14c    |        4 | Integrity digest for the PLAT_OWNER_AUTH_SLOT0 partition.                                                                                  |
| otp_ctrl.[`PLAT_OWNER_AUTH_SLOT1_DIGEST_0`](#plat_owner_auth_slot1_digest)     | 0x150    |        4 | Integrity digest for the PLAT_OWNER_AUTH_SLOT1 partition.                                                                                  |
| otp_ctrl.[`PLAT_OWNER_AUTH_SLOT1_DIGEST_1`](#plat_owner_auth_slot1_digest)     | 0x154    |        4 | Integrity digest for the PLAT_OWNER_AUTH_SLOT1 partition.                                                                                  |
| otp_ctrl.[`PLAT_OWNER_AUTH_SLOT2_DIGEST_0`](#plat_owner_auth_slot2_digest)     | 0x158    |        4 | Integrity digest for the PLAT_OWNER_AUTH_SLOT2 partition.                                                                                  |
| otp_ctrl.[`PLAT_OWNER_AUTH_SLOT2_DIGEST_1`](#plat_owner_auth_slot2_digest)     | 0x15c    |        4 | Integrity digest for the PLAT_OWNER_AUTH_SLOT2 partition.                                                                                  |
| otp_ctrl.[`PLAT_OWNER_AUTH_SLOT3_DIGEST_0`](#plat_owner_auth_slot3_digest)     | 0x160    |        4 | Integrity digest for the PLAT_OWNER_AUTH_SLOT3 partition.                                                                                  |
| otp_ctrl.[`PLAT_OWNER_AUTH_SLOT3_DIGEST_1`](#plat_owner_auth_slot3_digest)     | 0x164    |        4 | Integrity digest for the PLAT_OWNER_AUTH_SLOT3 partition.                                                                                  |
| otp_ctrl.[`ROM_PATCH_DIGEST_0`](#rom_patch_digest)                             | 0x168    |        4 | Integrity digest for the ROM_PATCH partition.                                                                                              |
| otp_ctrl.[`ROM_PATCH_DIGEST_1`](#rom_patch_digest)                             | 0x16c    |        4 | Integrity digest for the ROM_PATCH partition.                                                                                              |
| otp_ctrl.[`SOC_FUSES_CP_DIGEST_0`](#soc_fuses_cp_digest)                       | 0x170    |        4 | Integrity digest for the SOC_FUSES_CP partition.                                                                                           |
| otp_ctrl.[`SOC_FUSES_CP_DIGEST_1`](#soc_fuses_cp_digest)                       | 0x174    |        4 | Integrity digest for the SOC_FUSES_CP partition.                                                                                           |
| otp_ctrl.[`SOC_FUSES_FT_DIGEST_0`](#soc_fuses_ft_digest)                       | 0x178    |        4 | Integrity digest for the SOC_FUSES_FT partition.                                                                                           |
| otp_ctrl.[`SOC_FUSES_FT_DIGEST_1`](#soc_fuses_ft_digest)                       | 0x17c    |        4 | Integrity digest for the SOC_FUSES_FT partition.                                                                                           |
| otp_ctrl.[`HW_CFG0_DIGEST_0`](#hw_cfg0_digest)                                 | 0x180    |        4 | Integrity digest for the HW_CFG0 partition.                                                                                                |
| otp_ctrl.[`HW_CFG0_DIGEST_1`](#hw_cfg0_digest)                                 | 0x184    |        4 | Integrity digest for the HW_CFG0 partition.                                                                                                |
| otp_ctrl.[`HW_CFG1_DIGEST_0`](#hw_cfg1_digest)                                 | 0x188    |        4 | Integrity digest for the HW_CFG1 partition.                                                                                                |
| otp_ctrl.[`HW_CFG1_DIGEST_1`](#hw_cfg1_digest)                                 | 0x18c    |        4 | Integrity digest for the HW_CFG1 partition.                                                                                                |
| otp_ctrl.[`HW_CFG2_DIGEST_0`](#hw_cfg2_digest)                                 | 0x190    |        4 | Integrity digest for the HW_CFG2 partition.                                                                                                |
| otp_ctrl.[`HW_CFG2_DIGEST_1`](#hw_cfg2_digest)                                 | 0x194    |        4 | Integrity digest for the HW_CFG2 partition.                                                                                                |
| otp_ctrl.[`SECRET0_DIGEST_0`](#secret0_digest)                                 | 0x198    |        4 | Integrity digest for the SECRET0 partition.                                                                                                |
| otp_ctrl.[`SECRET0_DIGEST_1`](#secret0_digest)                                 | 0x19c    |        4 | Integrity digest for the SECRET0 partition.                                                                                                |
| otp_ctrl.[`SECRET1_DIGEST_0`](#secret1_digest)                                 | 0x1a0    |        4 | Integrity digest for the SECRET1 partition.                                                                                                |
| otp_ctrl.[`SECRET1_DIGEST_1`](#secret1_digest)                                 | 0x1a4    |        4 | Integrity digest for the SECRET1 partition.                                                                                                |
| otp_ctrl.[`SECRET2_DIGEST_0`](#secret2_digest)                                 | 0x1a8    |        4 | Integrity digest for the SECRET2 partition.                                                                                                |
| otp_ctrl.[`SECRET2_DIGEST_1`](#secret2_digest)                                 | 0x1ac    |        4 | Integrity digest for the SECRET2 partition.                                                                                                |
| otp_ctrl.[`SECRET3_DIGEST_0`](#secret3_digest)                                 | 0x1b0    |        4 | Integrity digest for the SECRET3 partition.                                                                                                |
| otp_ctrl.[`SECRET3_DIGEST_1`](#secret3_digest)                                 | 0x1b4    |        4 | Integrity digest for the SECRET3 partition.                                                                                                |
| otp_ctrl.[`SECRET4_DIGEST_0`](#secret4_digest)                                 | 0x1b8    |        4 | Integrity digest for the SECRET4 partition.                                                                                                |
| otp_ctrl.[`SECRET4_DIGEST_1`](#secret4_digest)                                 | 0x1bc    |        4 | Integrity digest for the SECRET4 partition.                                                                                                |
...
| Name                  | Offset   |
|:----------------------|:---------|
| DIRECT_ACCESS_WDATA_0 | 0x98     |
| DIRECT_ACCESS_WDATA_1 | 0x9c     |
...
| Name                  | Offset   |
|:----------------------|:---------|
| DIRECT_ACCESS_RDATA_0 | 0xa0     |
| DIRECT_ACCESS_RDATA_1 | 0xa4     |
...
| Name                 | Offset   |
|:---------------------|:---------|
| VENDOR_TEST_DIGEST_0 | 0x108    |
| VENDOR_TEST_DIGEST_1 | 0x10c    |
...
| Name                    | Offset   |
|:------------------------|:---------|
| CREATOR_SW_CFG_DIGEST_0 | 0x110    |
| CREATOR_SW_CFG_DIGEST_1 | 0x114    |
...
| Name                  | Offset   |
|:----------------------|:---------|
| OWNER_SW_CFG_DIGEST_0 | 0x118    |
| OWNER_SW_CFG_DIGEST_1 | 0x11c    |
...
| Name                          | Offset   |
|:------------------------------|:---------|
| ROT_CREATOR_IDENTITY_DIGEST_0 | 0x120    |
| ROT_CREATOR_IDENTITY_DIGEST_1 | 0x124    |
...
| Name                          | Offset   |
|:------------------------------|:---------|
| ROT_OWNER_AUTH_SLOT0_DIGEST_0 | 0x128    |
| ROT_OWNER_AUTH_SLOT0_DIGEST_1 | 0x12c    |
...
| Name                          | Offset   |
|:------------------------------|:---------|
| ROT_OWNER_AUTH_SLOT1_DIGEST_0 | 0x130    |
| ROT_OWNER_AUTH_SLOT1_DIGEST_1 | 0x134    |
...
| Name                           | Offset   |
|:-------------------------------|:---------|
| PLAT_INTEG_AUTH_SLOT0_DIGEST_0 | 0x138    |
| PLAT_INTEG_AUTH_SLOT0_DIGEST_1 | 0x13c    |
...
| Name                           | Offset   |
|:-------------------------------|:---------|
| PLAT_INTEG_AUTH_SLOT1_DIGEST_0 | 0x140    |
| PLAT_INTEG_AUTH_SLOT1_DIGEST_1 | 0x144    |
...
| Name                           | Offset   |
|:-------------------------------|:---------|
| PLAT_OWNER_AUTH_SLOT0_DIGEST_0 | 0x148    |
| PLAT_OWNER_AUTH_SLOT0_DIGEST_1 | 0x14c    |
...
| Name                           | Offset   |
|:-------------------------------|:---------|
| PLAT_OWNER_AUTH_SLOT1_DIGEST_0 | 0x150    |
| PLAT_OWNER_AUTH_SLOT1_DIGEST_1 | 0x154    |
...
| Name                           | Offset   |
|:-------------------------------|:---------|
| PLAT_OWNER_AUTH_SLOT2_DIGEST_0 | 0x158    |
| PLAT_OWNER_AUTH_SLOT2_DIGEST_1 | 0x15c    |
...
| Name                           | Offset   |
|:-------------------------------|:---------|
| PLAT_OWNER_AUTH_SLOT3_DIGEST_0 | 0x160    |
| PLAT_OWNER_AUTH_SLOT3_DIGEST_1 | 0x164    |
...
| Name               | Offset   |
|:-------------------|:---------|
| ROM_PATCH_DIGEST_0 | 0x168    |
| ROM_PATCH_DIGEST_1 | 0x16c    |
...
| Name                  | Offset   |
|:----------------------|:---------|
| SOC_FUSES_CP_DIGEST_0 | 0x170    |
| SOC_FUSES_CP_DIGEST_1 | 0x174    |
...
| Name                  | Offset   |
|:----------------------|:---------|
| SOC_FUSES_FT_DIGEST_0 | 0x178    |
| SOC_FUSES_FT_DIGEST_1 | 0x17c    |
...
| Name             | Offset   |
|:-----------------|:---------|
| HW_CFG0_DIGEST_0 | 0x180    |
| HW_CFG0_DIGEST_1 | 0x184    |
...
| Name             | Offset   |
|:-----------------|:---------|
| HW_CFG1_DIGEST_0 | 0x188    |
| HW_CFG1_DIGEST_1 | 0x18c    |
...
| Name             | Offset   |
|:-----------------|:---------|
| HW_CFG2_DIGEST_0 | 0x190    |
| HW_CFG2_DIGEST_1 | 0x194    |
...
| Name             | Offset   |
|:-----------------|:---------|
| SECRET0_DIGEST_0 | 0x198    |
| SECRET0_DIGEST_1 | 0x19c    |
...
| Name             | Offset   |
|:-----------------|:---------|
| SECRET1_DIGEST_0 | 0x1a0    |
| SECRET1_DIGEST_1 | 0x1a4    |
...
| Name             | Offset   |
|:-----------------|:---------|
| SECRET2_DIGEST_0 | 0x1a8    |
| SECRET2_DIGEST_1 | 0x1ac    |
...
| Name             | Offset   |
|:-----------------|:---------|
| SECRET3_DIGEST_0 | 0x1b0    |
| SECRET3_DIGEST_1 | 0x1b4    |
...
| Name             | Offset   |
|:-----------------|:---------|
| SECRET4_DIGEST_0 | 0x1b8    |
| SECRET4_DIGEST_1 | 0x1bc    |
