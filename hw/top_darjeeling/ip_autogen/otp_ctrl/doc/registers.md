...
| otp_ctrl.[`CHECK_TRIGGER_REGWEN`](#check_trigger_regwen)                       | 0xa0     |        4 | Register write enable for [`CHECK_TRIGGER.`](#check_trigger)                                                                               |
| otp_ctrl.[`CHECK_TRIGGER`](#check_trigger)                                     | 0xa4     |        4 | Command register for direct accesses.                                                                                                      |
| otp_ctrl.[`CHECK_REGWEN`](#check_regwen)                                       | 0xa8     |        4 | Register write enable for [`INTEGRITY_CHECK_PERIOD`](#integrity_check_period) and [`CONSISTENCY_CHECK_PERIOD.`](#consistency_check_period) |
