...
module otp_ctrl_core_reg_top (
  ...
  always_comb begin
    ...
    addr_hit[ 33] = (reg_addr == OTP_CTRL_DIRECT_ACCESS_REGWEN_OFFSET);
    addr_hit[ 34] = (reg_addr == OTP_CTRL_DIRECT_ACCESS_CMD_OFFSET);
    addr_hit[ 35] = (reg_addr == OTP_CTRL_DIRECT_ACCESS_ADDRESS_OFFSET);
    addr_hit[ 36] = (reg_addr == OTP_CTRL_DIRECT_ACCESS_WDATA_0_OFFSET);
    addr_hit[ 37] = (reg_addr == OTP_CTRL_DIRECT_ACCESS_WDATA_1_OFFSET);
    addr_hit[ 38] = (reg_addr == OTP_CTRL_DIRECT_ACCESS_RDATA_0_OFFSET);
    addr_hit[ 39] = (reg_addr == OTP_CTRL_DIRECT_ACCESS_RDATA_1_OFFSET);
    addr_hit[ 40] = (reg_addr == OTP_CTRL_CHECK_TRIGGER_REGWEN_OFFSET);
    addr_hit[ 41] = (reg_addr == OTP_CTRL_CHECK_TRIGGER_OFFSET);
    addr_hit[ 42] = (reg_addr == OTP_CTRL_CHECK_REGWEN_OFFSET);
    addr_hit[ 43] = (reg_addr == OTP_CTRL_CHECK_TIMEOUT_OFFSET);
    addr_hit[ 44] = (reg_addr == OTP_CTRL_INTEGRITY_CHECK_PERIOD_OFFSET);
    addr_hit[ 45] = (reg_addr == OTP_CTRL_CONSISTENCY_CHECK_PERIOD_OFFSET);
    addr_hit[ 46] = (reg_addr == OTP_CTRL_VENDOR_TEST_READ_LOCK_OFFSET);
    addr_hit[ 47] = (reg_addr == OTP_CTRL_CREATOR_SW_CFG_READ_LOCK_OFFSET);
    addr_hit[ 48] = (reg_addr == OTP_CTRL_OWNER_SW_CFG_READ_LOCK_OFFSET);
    addr_hit[ 49] = (reg_addr == OTP_CTRL_OWNERSHIP_SLOT_STATE_READ_LOCK_OFFSET);
    addr_hit[ 50] = (reg_addr == OTP_CTRL_ROT_CREATOR_IDENTITY_READ_LOCK_OFFSET);
    addr_hit[ 51] = (reg_addr == OTP_CTRL_ROT_OWNER_AUTH_SLOT0_READ_LOCK_OFFSET);
    addr_hit[ 52] = (reg_addr == OTP_CTRL_ROT_OWNER_AUTH_SLOT1_READ_LOCK_OFFSET);
    addr_hit[ 53] = (reg_addr == OTP_CTRL_PLAT_INTEG_AUTH_SLOT0_READ_LOCK_OFFSET);
    addr_hit[ 54] = (reg_addr == OTP_CTRL_PLAT_INTEG_AUTH_SLOT1_READ_LOCK_OFFSET);
    addr_hit[ 55] = (reg_addr == OTP_CTRL_PLAT_OWNER_AUTH_SLOT0_READ_LOCK_OFFSET);
    addr_hit[ 56] = (reg_addr == OTP_CTRL_PLAT_OWNER_AUTH_SLOT1_READ_LOCK_OFFSET);
    addr_hit[ 57] = (reg_addr == OTP_CTRL_PLAT_OWNER_AUTH_SLOT2_READ_LOCK_OFFSET);
    addr_hit[ 58] = (reg_addr == OTP_CTRL_PLAT_OWNER_AUTH_SLOT3_READ_LOCK_OFFSET);
    addr_hit[ 59] = (reg_addr == OTP_CTRL_EXT_NVM_READ_LOCK_OFFSET);
    addr_hit[ 60] = (reg_addr == OTP_CTRL_ROM_PATCH_READ_LOCK_OFFSET);
    addr_hit[ 61] = (reg_addr == OTP_CTRL_SOC_FUSES_CP_READ_LOCK_OFFSET);
    addr_hit[ 62] = (reg_addr == OTP_CTRL_SOC_FUSES_FT_READ_LOCK_OFFSET);
    addr_hit[ 63] = (reg_addr == OTP_CTRL_VENDOR_TEST_DIGEST_0_OFFSET);
    addr_hit[ 64] = (reg_addr == OTP_CTRL_VENDOR_TEST_DIGEST_1_OFFSET);
    addr_hit[ 65] = (reg_addr == OTP_CTRL_CREATOR_SW_CFG_DIGEST_0_OFFSET);
    addr_hit[ 66] = (reg_addr == OTP_CTRL_CREATOR_SW_CFG_DIGEST_1_OFFSET);
    addr_hit[ 67] = (reg_addr == OTP_CTRL_OWNER_SW_CFG_DIGEST_0_OFFSET);
    addr_hit[ 68] = (reg_addr == OTP_CTRL_OWNER_SW_CFG_DIGEST_1_OFFSET);
    addr_hit[ 69] = (reg_addr == OTP_CTRL_ROT_CREATOR_IDENTITY_DIGEST_0_OFFSET);
    addr_hit[ 70] = (reg_addr == OTP_CTRL_ROT_CREATOR_IDENTITY_DIGEST_1_OFFSET);
    addr_hit[ 71] = (reg_addr == OTP_CTRL_ROT_OWNER_AUTH_SLOT0_DIGEST_0_OFFSET);
    addr_hit[ 72] = (reg_addr == OTP_CTRL_ROT_OWNER_AUTH_SLOT0_DIGEST_1_OFFSET);
    addr_hit[ 73] = (reg_addr == OTP_CTRL_ROT_OWNER_AUTH_SLOT1_DIGEST_0_OFFSET);
    addr_hit[ 74] = (reg_addr == OTP_CTRL_ROT_OWNER_AUTH_SLOT1_DIGEST_1_OFFSET);
    addr_hit[ 75] = (reg_addr == OTP_CTRL_PLAT_INTEG_AUTH_SLOT0_DIGEST_0_OFFSET);
    addr_hit[ 76] = (reg_addr == OTP_CTRL_PLAT_INTEG_AUTH_SLOT0_DIGEST_1_OFFSET);
    addr_hit[ 77] = (reg_addr == OTP_CTRL_PLAT_INTEG_AUTH_SLOT1_DIGEST_0_OFFSET);
    addr_hit[ 78] = (reg_addr == OTP_CTRL_PLAT_INTEG_AUTH_SLOT1_DIGEST_1_OFFSET);
    addr_hit[ 79] = (reg_addr == OTP_CTRL_PLAT_OWNER_AUTH_SLOT0_DIGEST_0_OFFSET);
    addr_hit[ 80] = (reg_addr == OTP_CTRL_PLAT_OWNER_AUTH_SLOT0_DIGEST_1_OFFSET);
    addr_hit[ 81] = (reg_addr == OTP_CTRL_PLAT_OWNER_AUTH_SLOT1_DIGEST_0_OFFSET);
    addr_hit[ 82] = (reg_addr == OTP_CTRL_PLAT_OWNER_AUTH_SLOT1_DIGEST_1_OFFSET);
    addr_hit[ 83] = (reg_addr == OTP_CTRL_PLAT_OWNER_AUTH_SLOT2_DIGEST_0_OFFSET);
    addr_hit[ 84] = (reg_addr == OTP_CTRL_PLAT_OWNER_AUTH_SLOT2_DIGEST_1_OFFSET);
    addr_hit[ 85] = (reg_addr == OTP_CTRL_PLAT_OWNER_AUTH_SLOT3_DIGEST_0_OFFSET);
    addr_hit[ 86] = (reg_addr == OTP_CTRL_PLAT_OWNER_AUTH_SLOT3_DIGEST_1_OFFSET);
    addr_hit[ 87] = (reg_addr == OTP_CTRL_ROM_PATCH_DIGEST_0_OFFSET);
    addr_hit[ 88] = (reg_addr == OTP_CTRL_ROM_PATCH_DIGEST_1_OFFSET);
    addr_hit[ 89] = (reg_addr == OTP_CTRL_SOC_FUSES_CP_DIGEST_0_OFFSET);
    addr_hit[ 90] = (reg_addr == OTP_CTRL_SOC_FUSES_CP_DIGEST_1_OFFSET);
    addr_hit[ 91] = (reg_addr == OTP_CTRL_SOC_FUSES_FT_DIGEST_0_OFFSET);
    addr_hit[ 92] = (reg_addr == OTP_CTRL_SOC_FUSES_FT_DIGEST_1_OFFSET);
    addr_hit[ 93] = (reg_addr == OTP_CTRL_HW_CFG0_DIGEST_0_OFFSET);
    addr_hit[ 94] = (reg_addr == OTP_CTRL_HW_CFG0_DIGEST_1_OFFSET);
    addr_hit[ 95] = (reg_addr == OTP_CTRL_HW_CFG1_DIGEST_0_OFFSET);
    addr_hit[ 96] = (reg_addr == OTP_CTRL_HW_CFG1_DIGEST_1_OFFSET);
    addr_hit[ 97] = (reg_addr == OTP_CTRL_HW_CFG2_DIGEST_0_OFFSET);
    addr_hit[ 98] = (reg_addr == OTP_CTRL_HW_CFG2_DIGEST_1_OFFSET);
    addr_hit[ 99] = (reg_addr == OTP_CTRL_SECRET0_DIGEST_0_OFFSET);
    addr_hit[100] = (reg_addr == OTP_CTRL_SECRET0_DIGEST_1_OFFSET);
    addr_hit[101] = (reg_addr == OTP_CTRL_SECRET1_DIGEST_0_OFFSET);
    addr_hit[102] = (reg_addr == OTP_CTRL_SECRET1_DIGEST_1_OFFSET);
    addr_hit[103] = (reg_addr == OTP_CTRL_SECRET2_DIGEST_0_OFFSET);
    addr_hit[104] = (reg_addr == OTP_CTRL_SECRET2_DIGEST_1_OFFSET);
    addr_hit[105] = (reg_addr == OTP_CTRL_SECRET3_DIGEST_0_OFFSET);
    addr_hit[106] = (reg_addr == OTP_CTRL_SECRET3_DIGEST_1_OFFSET);
  end
  ...
  assign direct_access_regwen_re = addr_hit[33] & reg_re & !reg_error;
  assign direct_access_regwen_we = addr_hit[33] & reg_we & !reg_error;

  assign direct_access_regwen_wd = reg_wdata[0];
  assign direct_access_cmd_we = addr_hit[34] & reg_we & !reg_error;
  ...
  assign direct_access_address_we = addr_hit[35] & reg_we & !reg_error;

  assign direct_access_address_wd = reg_wdata[14:0];
  assign direct_access_wdata_0_we = addr_hit[36] & reg_we & !reg_error;

  assign direct_access_wdata_0_wd = reg_wdata[31:0];
  assign direct_access_wdata_1_we = addr_hit[37] & reg_we & !reg_error;

  assign direct_access_wdata_1_wd = reg_wdata[31:0];
  assign direct_access_rdata_0_re = addr_hit[38] & reg_re & !reg_error;
  assign direct_access_rdata_1_re = addr_hit[39] & reg_re & !reg_error;
  assign check_trigger_regwen_we = addr_hit[40] & reg_we & !reg_error;

  assign check_trigger_regwen_wd = reg_wdata[0];
  assign check_trigger_we = addr_hit[41] & reg_we & !reg_error;

  assign check_trigger_integrity_wd = reg_wdata[0];

  assign check_trigger_consistency_wd = reg_wdata[1];
  assign check_regwen_we = addr_hit[42] & reg_we & !reg_error;

  assign check_regwen_wd = reg_wdata[0];
  assign check_timeout_we = addr_hit[43] & reg_we & !reg_error;

  assign check_timeout_wd = reg_wdata[31:0];
  assign integrity_check_period_we = addr_hit[44] & reg_we & !reg_error;

  assign integrity_check_period_wd = reg_wdata[31:0];
  assign consistency_check_period_we = addr_hit[45] & reg_we & !reg_error;

  assign consistency_check_period_wd = reg_wdata[31:0];
  assign vendor_test_read_lock_we = addr_hit[46] & reg_we & !reg_error;

  assign vendor_test_read_lock_wd = reg_wdata[0];
  assign creator_sw_cfg_read_lock_we = addr_hit[47] & reg_we & !reg_error;

  assign creator_sw_cfg_read_lock_wd = reg_wdata[0];
  assign owner_sw_cfg_read_lock_we = addr_hit[48] & reg_we & !reg_error;

  assign owner_sw_cfg_read_lock_wd = reg_wdata[0];
  assign ownership_slot_state_read_lock_we = addr_hit[49] & reg_we & !reg_error;

  assign ownership_slot_state_read_lock_wd = reg_wdata[0];
  assign rot_creator_identity_read_lock_we = addr_hit[50] & reg_we & !reg_error;

  assign rot_creator_identity_read_lock_wd = reg_wdata[0];
  assign rot_owner_auth_slot0_read_lock_we = addr_hit[51] & reg_we & !reg_error;

  assign rot_owner_auth_slot0_read_lock_wd = reg_wdata[0];
  assign rot_owner_auth_slot1_read_lock_we = addr_hit[52] & reg_we & !reg_error;

  assign rot_owner_auth_slot1_read_lock_wd = reg_wdata[0];
  assign plat_integ_auth_slot0_read_lock_we = addr_hit[53] & reg_we & !reg_error;

  assign plat_integ_auth_slot0_read_lock_wd = reg_wdata[0];
  assign plat_integ_auth_slot1_read_lock_we = addr_hit[54] & reg_we & !reg_error;

  assign plat_integ_auth_slot1_read_lock_wd = reg_wdata[0];
  assign plat_owner_auth_slot0_read_lock_we = addr_hit[55] & reg_we & !reg_error;

  assign plat_owner_auth_slot0_read_lock_wd = reg_wdata[0];
  assign plat_owner_auth_slot1_read_lock_we = addr_hit[56] & reg_we & !reg_error;

  assign plat_owner_auth_slot1_read_lock_wd = reg_wdata[0];
  assign plat_owner_auth_slot2_read_lock_we = addr_hit[57] & reg_we & !reg_error;

  assign plat_owner_auth_slot2_read_lock_wd = reg_wdata[0];
  assign plat_owner_auth_slot3_read_lock_we = addr_hit[58] & reg_we & !reg_error;

  assign plat_owner_auth_slot3_read_lock_wd = reg_wdata[0];
  assign ext_nvm_read_lock_we = addr_hit[59] & reg_we & !reg_error;

  assign ext_nvm_read_lock_wd = reg_wdata[0];
  assign rom_patch_read_lock_we = addr_hit[60] & reg_we & !reg_error;

  assign rom_patch_read_lock_wd = reg_wdata[0];
  assign soc_fuses_cp_read_lock_we = addr_hit[61] & reg_we & !reg_error;

  assign soc_fuses_cp_read_lock_wd = reg_wdata[0];
  assign soc_fuses_ft_read_lock_we = addr_hit[62] & reg_we & !reg_error;

  assign soc_fuses_ft_read_lock_wd = reg_wdata[0];
  assign vendor_test_digest_0_re = addr_hit[63] & reg_re & !reg_error;
  assign vendor_test_digest_1_re = addr_hit[64] & reg_re & !reg_error;
  assign creator_sw_cfg_digest_0_re = addr_hit[65] & reg_re & !reg_error;
  assign creator_sw_cfg_digest_1_re = addr_hit[66] & reg_re & !reg_error;
  assign owner_sw_cfg_digest_0_re = addr_hit[67] & reg_re & !reg_error;
  assign owner_sw_cfg_digest_1_re = addr_hit[68] & reg_re & !reg_error;
  assign rot_creator_identity_digest_0_re = addr_hit[69] & reg_re & !reg_error;
  assign rot_creator_identity_digest_1_re = addr_hit[70] & reg_re & !reg_error;
  assign rot_owner_auth_slot0_digest_0_re = addr_hit[71] & reg_re & !reg_error;
  assign rot_owner_auth_slot0_digest_1_re = addr_hit[72] & reg_re & !reg_error;
  assign rot_owner_auth_slot1_digest_0_re = addr_hit[73] & reg_re & !reg_error;
  assign rot_owner_auth_slot1_digest_1_re = addr_hit[74] & reg_re & !reg_error;
  assign plat_integ_auth_slot0_digest_0_re = addr_hit[75] & reg_re & !reg_error;
  assign plat_integ_auth_slot0_digest_1_re = addr_hit[76] & reg_re & !reg_error;
  assign plat_integ_auth_slot1_digest_0_re = addr_hit[77] & reg_re & !reg_error;
  assign plat_integ_auth_slot1_digest_1_re = addr_hit[78] & reg_re & !reg_error;
  assign plat_owner_auth_slot0_digest_0_re = addr_hit[79] & reg_re & !reg_error;
  assign plat_owner_auth_slot0_digest_1_re = addr_hit[80] & reg_re & !reg_error;
  assign plat_owner_auth_slot1_digest_0_re = addr_hit[81] & reg_re & !reg_error;
  assign plat_owner_auth_slot1_digest_1_re = addr_hit[82] & reg_re & !reg_error;
  assign plat_owner_auth_slot2_digest_0_re = addr_hit[83] & reg_re & !reg_error;
  assign plat_owner_auth_slot2_digest_1_re = addr_hit[84] & reg_re & !reg_error;
  assign plat_owner_auth_slot3_digest_0_re = addr_hit[85] & reg_re & !reg_error;
  assign plat_owner_auth_slot3_digest_1_re = addr_hit[86] & reg_re & !reg_error;
  assign rom_patch_digest_0_re = addr_hit[87] & reg_re & !reg_error;
  assign rom_patch_digest_1_re = addr_hit[88] & reg_re & !reg_error;
  assign soc_fuses_cp_digest_0_re = addr_hit[89] & reg_re & !reg_error;
  assign soc_fuses_cp_digest_1_re = addr_hit[90] & reg_re & !reg_error;
  assign soc_fuses_ft_digest_0_re = addr_hit[91] & reg_re & !reg_error;
  assign soc_fuses_ft_digest_1_re = addr_hit[92] & reg_re & !reg_error;
  assign hw_cfg0_digest_0_re = addr_hit[93] & reg_re & !reg_error;
  assign hw_cfg0_digest_1_re = addr_hit[94] & reg_re & !reg_error;
  assign hw_cfg1_digest_0_re = addr_hit[95] & reg_re & !reg_error;
  assign hw_cfg1_digest_1_re = addr_hit[96] & reg_re & !reg_error;
  assign hw_cfg2_digest_0_re = addr_hit[97] & reg_re & !reg_error;
  assign hw_cfg2_digest_1_re = addr_hit[98] & reg_re & !reg_error;
  assign secret0_digest_0_re = addr_hit[99] & reg_re & !reg_error;
  assign secret0_digest_1_re = addr_hit[100] & reg_re & !reg_error;
  assign secret1_digest_0_re = addr_hit[101] & reg_re & !reg_error;
  assign secret1_digest_1_re = addr_hit[102] & reg_re & !reg_error;
  assign secret2_digest_0_re = addr_hit[103] & reg_re & !reg_error;
  assign secret2_digest_1_re = addr_hit[104] & reg_re & !reg_error;
  assign secret3_digest_0_re = addr_hit[105] & reg_re & !reg_error;
  assign secret3_digest_1_re = addr_hit[106] & reg_re & !reg_error;
  ...
  always_comb begin
    ...
    reg_we_check[33] = direct_access_regwen_we;
    reg_we_check[34] = direct_access_cmd_gated_we;
    reg_we_check[35] = direct_access_address_gated_we;
    reg_we_check[36] = direct_access_wdata_0_gated_we;
    reg_we_check[37] = direct_access_wdata_1_gated_we;
    reg_we_check[38] = 1'b0;
    reg_we_check[39] = 1'b0;
    reg_we_check[40] = check_trigger_regwen_we;
    reg_we_check[41] = check_trigger_gated_we;
    reg_we_check[42] = check_regwen_we;
    reg_we_check[43] = check_timeout_gated_we;
    reg_we_check[44] = integrity_check_period_gated_we;
    reg_we_check[45] = consistency_check_period_gated_we;
    reg_we_check[46] = vendor_test_read_lock_gated_we;
    reg_we_check[47] = creator_sw_cfg_read_lock_gated_we;
    reg_we_check[48] = owner_sw_cfg_read_lock_gated_we;
    reg_we_check[49] = ownership_slot_state_read_lock_gated_we;
    reg_we_check[50] = rot_creator_identity_read_lock_gated_we;
    reg_we_check[51] = rot_owner_auth_slot0_read_lock_gated_we;
    reg_we_check[52] = rot_owner_auth_slot1_read_lock_gated_we;
    reg_we_check[53] = plat_integ_auth_slot0_read_lock_gated_we;
    reg_we_check[54] = plat_integ_auth_slot1_read_lock_gated_we;
    reg_we_check[55] = plat_owner_auth_slot0_read_lock_gated_we;
    reg_we_check[56] = plat_owner_auth_slot1_read_lock_gated_we;
    reg_we_check[57] = plat_owner_auth_slot2_read_lock_gated_we;
    reg_we_check[58] = plat_owner_auth_slot3_read_lock_gated_we;
    reg_we_check[59] = ext_nvm_read_lock_gated_we;
    reg_we_check[60] = rom_patch_read_lock_gated_we;
    reg_we_check[61] = soc_fuses_cp_read_lock_gated_we;
    reg_we_check[62] = soc_fuses_ft_read_lock_gated_we;
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[5]: begin
        ...
        reg_rdata_next[24] = partition_status_0_life_cycle_error_qs;
      end
