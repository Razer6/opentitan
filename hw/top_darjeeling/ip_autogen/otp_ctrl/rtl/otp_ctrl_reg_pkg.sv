...
package otp_ctrl_reg_pkg;
  ...
  parameter int RomPatchSize = 10744;
  parameter int RomPatchDataOffset = 4592;
  parameter int RomPatchDataSize = 9192;
  parameter int RomPatchDigestOffset = 15320;
  parameter int RomPatchDigestSize = 8;
  parameter int RomPatchZerOffset = 15328;
  parameter int RomPatchZerSize = 8;
  parameter int SocFusesCpOffset = 15336;
  parameter int SocFusesCpSize = 392;
  parameter int SocFusesCp1DataOffset = 15336;
  parameter int SocFusesCp1DataSize = 256;
  parameter int SocFusesCp2DataOffset = 15592;
  parameter int SocFusesCp2DataSize = 128;
  parameter int SocFusesCpDigestOffset = 15720;
  parameter int SocFusesCpDigestSize = 8;
  parameter int SocFusesFtOffset = 15728;
  parameter int SocFusesFtSize = 4232;
  parameter int SocFusesFt1DataOffset = 15728;
  parameter int SocFusesFt1DataSize = 384;
  parameter int SocFusesFt2DataOffset = 16112;
