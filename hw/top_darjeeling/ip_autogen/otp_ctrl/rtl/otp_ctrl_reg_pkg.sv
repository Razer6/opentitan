...
package otp_ctrl_reg_pkg;
  ...
  parameter int CreatorSwCfgSize = 192;
  ...
  parameter int CreatorSwCfgRmaSpinEnOffset = 232;
  parameter int CreatorSwCfgRmaSpinEnSize = 4;
  parameter int CreatorSwCfgRmaSpinCyclesOffset = 236;
  parameter int CreatorSwCfgRmaSpinCyclesSize = 4;
  parameter int CreatorSwCfgSramKeyRenewEnOffset = 240;
  parameter int CreatorSwCfgSramKeyRenewEnSize = 4;
  parameter int CreatorSwCfgDigestOffset = 248;
  parameter int CreatorSwCfgDigestSize = 8;
  parameter int CreatorSwCfgZerOffset = 256;
  parameter int CreatorSwCfgZerSize = 8;
  parameter int OwnerSwCfgOffset = 264;
  parameter int OwnerSwCfgSize = 976;
  parameter int OwnerSwCfgRomErrorReportingOffset = 264;
  parameter int OwnerSwCfgRomErrorReportingSize = 4;
  parameter int OwnerSwCfgRomBootstrapDisOffset = 268;
  parameter int OwnerSwCfgRomBootstrapDisSize = 4;
  parameter int OwnerSwCfgRomAlertClassEnOffset = 272;
  parameter int OwnerSwCfgRomAlertClassEnSize = 4;
  parameter int OwnerSwCfgRomAlertEscalationOffset = 276;
  parameter int OwnerSwCfgRomAlertEscalationSize = 4;
  parameter int OwnerSwCfgRomAlertClassificationOffset = 280;
  parameter int OwnerSwCfgRomAlertClassificationSize = 788;
  parameter int OwnerSwCfgRomLocalAlertClassificationOffset = 1068;
  parameter int OwnerSwCfgRomLocalAlertClassificationSize = 28;
  parameter int OwnerSwCfgRomAlertAccumThreshOffset = 1096;
  parameter int OwnerSwCfgRomAlertAccumThreshSize = 16;
  parameter int OwnerSwCfgRomAlertTimeoutCyclesOffset = 1112;
  parameter int OwnerSwCfgRomAlertTimeoutCyclesSize = 16;
  parameter int OwnerSwCfgRomAlertPhaseCyclesOffset = 1128;
  parameter int OwnerSwCfgRomAlertPhaseCyclesSize = 64;
  parameter int OwnerSwCfgRomAlertDigestProdOffset = 1192;
  parameter int OwnerSwCfgRomAlertDigestProdSize = 4;
  parameter int OwnerSwCfgRomAlertDigestProdEndOffset = 1196;
  parameter int OwnerSwCfgRomAlertDigestProdEndSize = 4;
  parameter int OwnerSwCfgRomAlertDigestDevOffset = 1200;
  parameter int OwnerSwCfgRomAlertDigestDevSize = 4;
  parameter int OwnerSwCfgRomAlertDigestRmaOffset = 1204;
  parameter int OwnerSwCfgRomAlertDigestRmaSize = 4;
  parameter int OwnerSwCfgRomWatchdogBiteThresholdCyclesOffset = 1208;
  parameter int OwnerSwCfgRomWatchdogBiteThresholdCyclesSize = 4;
  parameter int OwnerSwCfgRomKeymgrOtpMeasEnOffset = 1212;
  parameter int OwnerSwCfgRomKeymgrOtpMeasEnSize = 4;
  parameter int OwnerSwCfgRomRstmgrInfoEnOffset = 1216;
  parameter int OwnerSwCfgRomRstmgrInfoEnSize = 4;
  parameter int OwnerSwCfgDigestOffset = 1224;
  parameter int OwnerSwCfgDigestSize = 8;
  parameter int OwnerSwCfgZerOffset = 1232;
  parameter int OwnerSwCfgZerSize = 8;
  parameter int OwnershipSlotStateOffset = 1240;
  parameter int OwnershipSlotStateSize = 56;
  parameter int OwnershipSlotStateRotOwnerAuthOffset = 1240;
  parameter int OwnershipSlotStateRotOwnerAuthSize = 16;
  parameter int OwnershipSlotStatePlatIntegAuthOffset = 1256;
  parameter int OwnershipSlotStatePlatIntegAuthSize = 16;
  parameter int OwnershipSlotStatePlatOwnerAuthOffset = 1272;
  parameter int OwnershipSlotStatePlatOwnerAuthSize = 16;
  parameter int OwnershipSlotStateZerOffset = 1288;
  parameter int OwnershipSlotStateZerSize = 8;
  parameter int RotCreatorIdentityOffset = 1296;
  parameter int RotCreatorIdentitySize = 800;
  parameter int RotCreatorIdentityCertOffset = 1296;
  parameter int RotCreatorIdentityCertSize = 768;
  parameter int RotCreatorIdentityCertCmacOffset = 2064;
  parameter int RotCreatorIdentityCertCmacSize = 16;
  parameter int RotCreatorIdentityDigestOffset = 2080;
  parameter int RotCreatorIdentityDigestSize = 8;
  parameter int RotCreatorIdentityZerOffset = 2088;
  parameter int RotCreatorIdentityZerSize = 8;
  parameter int RotOwnerAuthSlot0Offset = 2096;
  parameter int RotOwnerAuthSlot0Size = 344;
  parameter int RotOwnerAuthSlot0NonRawMfwCodesignKeyTypeOffset = 2096;
  parameter int RotOwnerAuthSlot0NonRawMfwCodesignKeyTypeSize = 4;
  parameter int RotOwnerAuthSlot0NonRawMfwCodesignKeyRoleOffset = 2100;
  parameter int RotOwnerAuthSlot0NonRawMfwCodesignKeyRoleSize = 4;
  parameter int RotOwnerAuthSlot0NonRawMfwCodesignKeyOffset = 2104;
  parameter int RotOwnerAuthSlot0NonRawMfwCodesignKeySize = 64;
  parameter int RotOwnerAuthSlot0Rom2PatchSigverifyKeyTypeOffset = 2168;
  parameter int RotOwnerAuthSlot0Rom2PatchSigverifyKeyTypeSize = 4;
  parameter int RotOwnerAuthSlot0Rom2PatchSigverifyKeyRoleOffset = 2172;
  parameter int RotOwnerAuthSlot0Rom2PatchSigverifyKeyRoleSize = 4;
  parameter int RotOwnerAuthSlot0Rom2PatchSigverifyKeyOffset = 2176;
  parameter int RotOwnerAuthSlot0Rom2PatchSigverifyKeySize = 64;
  parameter int RotOwnerAuthSlot0KeymanifestKeyTypeOffset = 2240;
  parameter int RotOwnerAuthSlot0KeymanifestKeyTypeSize = 4;
  parameter int RotOwnerAuthSlot0KeymanifestKeyRoleOffset = 2244;
  parameter int RotOwnerAuthSlot0KeymanifestKeyRoleSize = 4;
  parameter int RotOwnerAuthSlot0KeymanifestKeyOffset = 2248;
  parameter int RotOwnerAuthSlot0KeymanifestKeySize = 64;
  parameter int RotOwnerAuthSlot0KeyDeviceIdOffset = 2312;
  parameter int RotOwnerAuthSlot0KeyDeviceIdSize = 32;
  parameter int RotOwnerAuthSlot0KeyMetadataOffset = 2344;
  parameter int RotOwnerAuthSlot0KeyMetadataSize = 16;
  parameter int RotOwnerAuthSlot0KeySignatureOffset = 2360;
  parameter int RotOwnerAuthSlot0KeySignatureSize = 64;
  parameter int RotOwnerAuthSlot0DigestOffset = 2424;
  parameter int RotOwnerAuthSlot0DigestSize = 8;
  parameter int RotOwnerAuthSlot0ZerOffset = 2432;
  parameter int RotOwnerAuthSlot0ZerSize = 8;
  parameter int RotOwnerAuthSlot1Offset = 2440;
  parameter int RotOwnerAuthSlot1Size = 160;
  parameter int RotOwnerAuthSlot1KeymanifestKeyTypeOffset = 2440;
  parameter int RotOwnerAuthSlot1KeymanifestKeyTypeSize = 4;
  parameter int RotOwnerAuthSlot1KeymanifestKeyRoleOffset = 2444;
  parameter int RotOwnerAuthSlot1KeymanifestKeyRoleSize = 4;
  parameter int RotOwnerAuthSlot1KeymanifestKeyOffset = 2448;
  parameter int RotOwnerAuthSlot1KeymanifestKeySize = 64;
  parameter int RotOwnerAuthSlot1Unlock4xferKeyTypeOffset = 2512;
  parameter int RotOwnerAuthSlot1Unlock4xferKeyTypeSize = 4;
  parameter int RotOwnerAuthSlot1Unlock4xferKeyRoleOffset = 2516;
  parameter int RotOwnerAuthSlot1Unlock4xferKeyRoleSize = 4;
  parameter int RotOwnerAuthSlot1Unlock4xferKeyOffset = 2520;
  parameter int RotOwnerAuthSlot1Unlock4xferKeySize = 64;
  parameter int RotOwnerAuthSlot1DigestOffset = 2584;
  parameter int RotOwnerAuthSlot1DigestSize = 8;
  parameter int RotOwnerAuthSlot1ZerOffset = 2592;
  parameter int RotOwnerAuthSlot1ZerSize = 8;
  parameter int PlatIntegAuthSlot0Offset = 2600;
  parameter int PlatIntegAuthSlot0Size = 160;
  parameter int PlatIntegAuthSlot0KeymanifestKeyTypeOffset = 2600;
  parameter int PlatIntegAuthSlot0KeymanifestKeyTypeSize = 4;
  parameter int PlatIntegAuthSlot0KeymanifestKeyRoleOffset = 2604;
  parameter int PlatIntegAuthSlot0KeymanifestKeyRoleSize = 4;
  parameter int PlatIntegAuthSlot0KeymanifestKeyOffset = 2608;
  parameter int PlatIntegAuthSlot0KeymanifestKeySize = 64;
  parameter int PlatIntegAuthSlot0Unlock4xferKeyTypeOffset = 2672;
  parameter int PlatIntegAuthSlot0Unlock4xferKeyTypeSize = 4;
  parameter int PlatIntegAuthSlot0Unlock4xferKeyRoleOffset = 2676;
  parameter int PlatIntegAuthSlot0Unlock4xferKeyRoleSize = 4;
  parameter int PlatIntegAuthSlot0Unlock4xferKeyOffset = 2680;
  parameter int PlatIntegAuthSlot0Unlock4xferKeySize = 64;
  parameter int PlatIntegAuthSlot0DigestOffset = 2744;
  parameter int PlatIntegAuthSlot0DigestSize = 8;
  parameter int PlatIntegAuthSlot0ZerOffset = 2752;
  parameter int PlatIntegAuthSlot0ZerSize = 8;
  parameter int PlatIntegAuthSlot1Offset = 2760;
  parameter int PlatIntegAuthSlot1Size = 160;
  parameter int PlatIntegAuthSlot1KeymanifestKeyTypeOffset = 2760;
  parameter int PlatIntegAuthSlot1KeymanifestKeyTypeSize = 4;
  parameter int PlatIntegAuthSlot1KeymanifestKeyRoleOffset = 2764;
  parameter int PlatIntegAuthSlot1KeymanifestKeyRoleSize = 4;
  parameter int PlatIntegAuthSlot1KeymanifestKeyOffset = 2768;
  parameter int PlatIntegAuthSlot1KeymanifestKeySize = 64;
  parameter int PlatIntegAuthSlot1Unlock4xferKeyTypeOffset = 2832;
  parameter int PlatIntegAuthSlot1Unlock4xferKeyTypeSize = 4;
  parameter int PlatIntegAuthSlot1Unlock4xferKeyRoleOffset = 2836;
  parameter int PlatIntegAuthSlot1Unlock4xferKeyRoleSize = 4;
  parameter int PlatIntegAuthSlot1Unlock4xferKeyOffset = 2840;
  parameter int PlatIntegAuthSlot1Unlock4xferKeySize = 64;
  parameter int PlatIntegAuthSlot1DigestOffset = 2904;
  parameter int PlatIntegAuthSlot1DigestSize = 8;
  parameter int PlatIntegAuthSlot1ZerOffset = 2912;
  parameter int PlatIntegAuthSlot1ZerSize = 8;
  parameter int PlatOwnerAuthSlot0Offset = 2920;
  parameter int PlatOwnerAuthSlot0Size = 160;
  parameter int PlatOwnerAuthSlot0KeymanifestKeyTypeOffset = 2920;
  parameter int PlatOwnerAuthSlot0KeymanifestKeyTypeSize = 4;
  parameter int PlatOwnerAuthSlot0KeymanifestKeyRoleOffset = 2924;
  parameter int PlatOwnerAuthSlot0KeymanifestKeyRoleSize = 4;
  parameter int PlatOwnerAuthSlot0KeymanifestKeyOffset = 2928;
  parameter int PlatOwnerAuthSlot0KeymanifestKeySize = 64;
  parameter int PlatOwnerAuthSlot0Unlock4xferKeyTypeOffset = 2992;
  parameter int PlatOwnerAuthSlot0Unlock4xferKeyTypeSize = 4;
  parameter int PlatOwnerAuthSlot0Unlock4xferKeyRoleOffset = 2996;
  parameter int PlatOwnerAuthSlot0Unlock4xferKeyRoleSize = 4;
  parameter int PlatOwnerAuthSlot0Unlock4xferKeyOffset = 3000;
  parameter int PlatOwnerAuthSlot0Unlock4xferKeySize = 64;
  parameter int PlatOwnerAuthSlot0DigestOffset = 3064;
  parameter int PlatOwnerAuthSlot0DigestSize = 8;
  parameter int PlatOwnerAuthSlot0ZerOffset = 3072;
  parameter int PlatOwnerAuthSlot0ZerSize = 8;
  parameter int PlatOwnerAuthSlot1Offset = 3080;
  parameter int PlatOwnerAuthSlot1Size = 160;
  parameter int PlatOwnerAuthSlot1KeymanifestKeyTypeOffset = 3080;
  parameter int PlatOwnerAuthSlot1KeymanifestKeyTypeSize = 4;
  parameter int PlatOwnerAuthSlot1KeymanifestKeyRoleOffset = 3084;
  parameter int PlatOwnerAuthSlot1KeymanifestKeyRoleSize = 4;
  parameter int PlatOwnerAuthSlot1KeymanifestKeyOffset = 3088;
  parameter int PlatOwnerAuthSlot1KeymanifestKeySize = 64;
  parameter int PlatOwnerAuthSlot1Unlock4xferKeyTypeOffset = 3152;
  parameter int PlatOwnerAuthSlot1Unlock4xferKeyTypeSize = 4;
  parameter int PlatOwnerAuthSlot1Unlock4xferKeyRoleOffset = 3156;
  parameter int PlatOwnerAuthSlot1Unlock4xferKeyRoleSize = 4;
  parameter int PlatOwnerAuthSlot1Unlock4xferKeyOffset = 3160;
  parameter int PlatOwnerAuthSlot1Unlock4xferKeySize = 64;
  parameter int PlatOwnerAuthSlot1DigestOffset = 3224;
  parameter int PlatOwnerAuthSlot1DigestSize = 8;
  parameter int PlatOwnerAuthSlot1ZerOffset = 3232;
  parameter int PlatOwnerAuthSlot1ZerSize = 8;
  parameter int PlatOwnerAuthSlot2Offset = 3240;
  parameter int PlatOwnerAuthSlot2Size = 160;
  parameter int PlatOwnerAuthSlot2KeymanifestKeyTypeOffset = 3240;
  parameter int PlatOwnerAuthSlot2KeymanifestKeyTypeSize = 4;
  parameter int PlatOwnerAuthSlot2KeymanifestKeyRoleOffset = 3244;
  parameter int PlatOwnerAuthSlot2KeymanifestKeyRoleSize = 4;
  parameter int PlatOwnerAuthSlot2KeymanifestKeyOffset = 3248;
  parameter int PlatOwnerAuthSlot2KeymanifestKeySize = 64;
  parameter int PlatOwnerAuthSlot2Unlock4xferKeyTypeOffset = 3312;
  parameter int PlatOwnerAuthSlot2Unlock4xferKeyTypeSize = 4;
  parameter int PlatOwnerAuthSlot2Unlock4xferKeyRoleOffset = 3316;
  parameter int PlatOwnerAuthSlot2Unlock4xferKeyRoleSize = 4;
  parameter int PlatOwnerAuthSlot2Unlock4xferKeyOffset = 3320;
  parameter int PlatOwnerAuthSlot2Unlock4xferKeySize = 64;
  parameter int PlatOwnerAuthSlot2DigestOffset = 3384;
  parameter int PlatOwnerAuthSlot2DigestSize = 8;
  parameter int PlatOwnerAuthSlot2ZerOffset = 3392;
  parameter int PlatOwnerAuthSlot2ZerSize = 8;
  parameter int PlatOwnerAuthSlot3Offset = 3400;
  parameter int PlatOwnerAuthSlot3Size = 160;
  parameter int PlatOwnerAuthSlot3KeymanifestKeyTypeOffset = 3400;
  parameter int PlatOwnerAuthSlot3KeymanifestKeyTypeSize = 4;
  parameter int PlatOwnerAuthSlot3KeymanifestKeyRoleOffset = 3404;
  parameter int PlatOwnerAuthSlot3KeymanifestKeyRoleSize = 4;
  parameter int PlatOwnerAuthSlot3KeymanifestKeyOffset = 3408;
  parameter int PlatOwnerAuthSlot3KeymanifestKeySize = 64;
  parameter int PlatOwnerAuthSlot3Unlock4xferKeyTypeOffset = 3472;
  parameter int PlatOwnerAuthSlot3Unlock4xferKeyTypeSize = 4;
  parameter int PlatOwnerAuthSlot3Unlock4xferKeyRoleOffset = 3476;
  parameter int PlatOwnerAuthSlot3Unlock4xferKeyRoleSize = 4;
  parameter int PlatOwnerAuthSlot3Unlock4xferKeyOffset = 3480;
  parameter int PlatOwnerAuthSlot3Unlock4xferKeySize = 64;
  parameter int PlatOwnerAuthSlot3DigestOffset = 3544;
  parameter int PlatOwnerAuthSlot3DigestSize = 8;
  parameter int PlatOwnerAuthSlot3ZerOffset = 3552;
  parameter int PlatOwnerAuthSlot3ZerSize = 8;
  parameter int ExtNvmOffset = 3560;
  parameter int ExtNvmSize = 1032;
  parameter int ExtNvmAntireplayFreshnessCntOffset = 3560;
  parameter int ExtNvmAntireplayFreshnessCntSize = 1024;
  parameter int ExtNvmZerOffset = 4584;
  parameter int ExtNvmZerSize = 8;
  parameter int RomPatchOffset = 4592;
  parameter int RomPatchSize = 11256;
  parameter int RomPatchDataOffset = 4592;
  parameter int RomPatchDataSize = 9192;
  parameter int RomPatchDigestOffset = 15832;
  parameter int RomPatchDigestSize = 8;
  parameter int RomPatchZerOffset = 15840;
  parameter int RomPatchZerSize = 8;
  parameter int SocFusesCpOffset = 15848;
  parameter int SocFusesCpSize = 520;
  parameter int SocFusesCp1DataOffset = 15848;
  parameter int SocFusesCp1DataSize = 256;
  parameter int SocFusesCp2DataOffset = 16104;
  parameter int SocFusesCp2DataSize = 256;
  parameter int SocFusesCpDigestOffset = 16360;
  parameter int SocFusesCpDigestSize = 8;
  parameter int SocFusesFtOffset = 16368;
  parameter int SocFusesFtSize = 3592;
  parameter int SocFusesFt1DataOffset = 16368;
  parameter int SocFusesFt1DataSize = 512;
  parameter int SocFusesFt2DataOffset = 16880;
  parameter int SocFusesFt2DataSize = 3072;
  parameter int SocFusesFtDigestOffset = 19952;
  parameter int SocFusesFtDigestSize = 8;
  parameter int HwCfg0Offset = 19960;
  parameter int HwCfg0Size = 48;
  parameter int DeviceIdOffset = 19960;
  parameter int DeviceIdSize = 32;
  parameter int HwCfg0DigestOffset = 19992;
  parameter int HwCfg0DigestSize = 8;
  parameter int HwCfg0ZerOffset = 20000;
  parameter int HwCfg0ZerSize = 8;
  parameter int HwCfg1Offset = 20008;
  parameter int HwCfg1Size = 24;
  parameter int EnCsrngSwAppReadOffset = 20008;
  parameter int EnCsrngSwAppReadSize = 1;
  parameter int EnSramIfetchOffset = 20009;
  parameter int EnSramIfetchSize = 1;
  parameter int HwCfg1DigestOffset = 20016;
  parameter int HwCfg1DigestSize = 8;
  parameter int HwCfg1ZerOffset = 20024;
  parameter int HwCfg1ZerSize = 8;
  parameter int HwCfg2Offset = 20032;
  parameter int HwCfg2Size = 56;
  parameter int SocDbgStateOffset = 20032;
  parameter int SocDbgStateSize = 4;
  parameter int ManufStateOffset = 20036;
  parameter int ManufStateSize = 32;
  parameter int HwCfg2DigestOffset = 20072;
  parameter int HwCfg2DigestSize = 8;
  parameter int HwCfg2ZerOffset = 20080;
  parameter int HwCfg2ZerSize = 8;
  parameter int Secret0Offset = 20088;
  parameter int Secret0Size = 48;
  parameter int TestUnlockTokenOffset = 20088;
  parameter int TestUnlockTokenSize = 16;
  parameter int TestExitTokenOffset = 20104;
  parameter int TestExitTokenSize = 16;
  parameter int Secret0DigestOffset = 20120;
  parameter int Secret0DigestSize = 8;
  parameter int Secret0ZerOffset = 20128;
  parameter int Secret0ZerSize = 8;
  parameter int Secret1Offset = 20136;
  parameter int Secret1Size = 32;
  parameter int SramDataKeySeedOffset = 20136;
  parameter int SramDataKeySeedSize = 16;
  parameter int Secret1DigestOffset = 20152;
  parameter int Secret1DigestSize = 8;
  parameter int Secret1ZerOffset = 20160;
  parameter int Secret1ZerSize = 8;
  parameter int Secret2Offset = 20168;
  parameter int Secret2Size = 128;
  parameter int RmaTokenOffset = 20168;
  parameter int RmaTokenSize = 16;
  parameter int CreatorRootKeyShare0Offset = 20184;
  parameter int CreatorRootKeyShare0Size = 32;
  parameter int CreatorRootKeyShare1Offset = 20216;
  parameter int CreatorRootKeyShare1Size = 32;
  parameter int CreatorSeedOffset = 20248;
  parameter int CreatorSeedSize = 32;
  parameter int Secret2DigestOffset = 20280;
  parameter int Secret2DigestSize = 8;
  parameter int Secret2ZerOffset = 20288;
  parameter int Secret2ZerSize = 8;
  parameter int Secret3Offset = 20296;
  parameter int Secret3Size = 48;
  parameter int OwnerSeedOffset = 20296;
  parameter int OwnerSeedSize = 32;
  parameter int Secret3DigestOffset = 20328;
  parameter int Secret3DigestSize = 8;
  parameter int Secret3ZerOffset = 20336;
  parameter int Secret3ZerSize = 8;
  parameter int Secret4Offset = 20344;
  parameter int Secret4Size = 48;
  parameter int UcieCtaSeedOffset = 20344;
  parameter int UcieCtaSeedSize = 32;
  ...
  typedef struct packed {
    otp_ctrl_hw2reg_intr_state_reg_t intr_state; // [1660:1657]
    otp_ctrl_hw2reg_status_reg_t status; // [1656:1647]
    otp_ctrl_hw2reg_partition_status_0_reg_t partition_status_0; // [1646:1621]
    otp_ctrl_hw2reg_err_code_mreg_t [27:0] err_code; // [1620:1537]
  ...
  parameter logic [CoreAw-1:0] OTP_CTRL_VENDOR_TEST_DIGEST_0_OFFSET = 16'h 100;
  parameter logic [CoreAw-1:0] OTP_CTRL_VENDOR_TEST_DIGEST_1_OFFSET = 16'h 104;
  parameter logic [CoreAw-1:0] OTP_CTRL_CREATOR_SW_CFG_DIGEST_0_OFFSET = 16'h 108;
  parameter logic [CoreAw-1:0] OTP_CTRL_CREATOR_SW_CFG_DIGEST_1_OFFSET = 16'h 10c;
  parameter logic [CoreAw-1:0] OTP_CTRL_OWNER_SW_CFG_DIGEST_0_OFFSET = 16'h 110;
  parameter logic [CoreAw-1:0] OTP_CTRL_OWNER_SW_CFG_DIGEST_1_OFFSET = 16'h 114;
  parameter logic [CoreAw-1:0] OTP_CTRL_ROT_CREATOR_IDENTITY_DIGEST_0_OFFSET = 16'h 118;
  parameter logic [CoreAw-1:0] OTP_CTRL_ROT_CREATOR_IDENTITY_DIGEST_1_OFFSET = 16'h 11c;
  parameter logic [CoreAw-1:0] OTP_CTRL_ROT_OWNER_AUTH_SLOT0_DIGEST_0_OFFSET = 16'h 120;
  parameter logic [CoreAw-1:0] OTP_CTRL_ROT_OWNER_AUTH_SLOT0_DIGEST_1_OFFSET = 16'h 124;
  parameter logic [CoreAw-1:0] OTP_CTRL_ROT_OWNER_AUTH_SLOT1_DIGEST_0_OFFSET = 16'h 128;
  parameter logic [CoreAw-1:0] OTP_CTRL_ROT_OWNER_AUTH_SLOT1_DIGEST_1_OFFSET = 16'h 12c;
  parameter logic [CoreAw-1:0] OTP_CTRL_PLAT_INTEG_AUTH_SLOT0_DIGEST_0_OFFSET = 16'h 130;
  parameter logic [CoreAw-1:0] OTP_CTRL_PLAT_INTEG_AUTH_SLOT0_DIGEST_1_OFFSET = 16'h 134;
  parameter logic [CoreAw-1:0] OTP_CTRL_PLAT_INTEG_AUTH_SLOT1_DIGEST_0_OFFSET = 16'h 138;
  parameter logic [CoreAw-1:0] OTP_CTRL_PLAT_INTEG_AUTH_SLOT1_DIGEST_1_OFFSET = 16'h 13c;
  parameter logic [CoreAw-1:0] OTP_CTRL_PLAT_OWNER_AUTH_SLOT0_DIGEST_0_OFFSET = 16'h 140;
  parameter logic [CoreAw-1:0] OTP_CTRL_PLAT_OWNER_AUTH_SLOT0_DIGEST_1_OFFSET = 16'h 144;
  parameter logic [CoreAw-1:0] OTP_CTRL_PLAT_OWNER_AUTH_SLOT1_DIGEST_0_OFFSET = 16'h 148;
  parameter logic [CoreAw-1:0] OTP_CTRL_PLAT_OWNER_AUTH_SLOT1_DIGEST_1_OFFSET = 16'h 14c;
  parameter logic [CoreAw-1:0] OTP_CTRL_PLAT_OWNER_AUTH_SLOT2_DIGEST_0_OFFSET = 16'h 150;
  parameter logic [CoreAw-1:0] OTP_CTRL_PLAT_OWNER_AUTH_SLOT2_DIGEST_1_OFFSET = 16'h 154;
  parameter logic [CoreAw-1:0] OTP_CTRL_PLAT_OWNER_AUTH_SLOT3_DIGEST_0_OFFSET = 16'h 158;
  parameter logic [CoreAw-1:0] OTP_CTRL_PLAT_OWNER_AUTH_SLOT3_DIGEST_1_OFFSET = 16'h 15c;
  parameter logic [CoreAw-1:0] OTP_CTRL_ROM_PATCH_DIGEST_0_OFFSET = 16'h 160;
  parameter logic [CoreAw-1:0] OTP_CTRL_ROM_PATCH_DIGEST_1_OFFSET = 16'h 164;
  parameter logic [CoreAw-1:0] OTP_CTRL_SOC_FUSES_CP_DIGEST_0_OFFSET = 16'h 168;
  parameter logic [CoreAw-1:0] OTP_CTRL_SOC_FUSES_CP_DIGEST_1_OFFSET = 16'h 16c;
  parameter logic [CoreAw-1:0] OTP_CTRL_SOC_FUSES_FT_DIGEST_0_OFFSET = 16'h 170;
  parameter logic [CoreAw-1:0] OTP_CTRL_SOC_FUSES_FT_DIGEST_1_OFFSET = 16'h 174;
  parameter logic [CoreAw-1:0] OTP_CTRL_HW_CFG0_DIGEST_0_OFFSET = 16'h 178;
  parameter logic [CoreAw-1:0] OTP_CTRL_HW_CFG0_DIGEST_1_OFFSET = 16'h 17c;
  parameter logic [CoreAw-1:0] OTP_CTRL_HW_CFG1_DIGEST_0_OFFSET = 16'h 180;
  parameter logic [CoreAw-1:0] OTP_CTRL_HW_CFG1_DIGEST_1_OFFSET = 16'h 184;
  parameter logic [CoreAw-1:0] OTP_CTRL_HW_CFG2_DIGEST_0_OFFSET = 16'h 188;
  parameter logic [CoreAw-1:0] OTP_CTRL_HW_CFG2_DIGEST_1_OFFSET = 16'h 18c;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET0_DIGEST_0_OFFSET = 16'h 190;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET0_DIGEST_1_OFFSET = 16'h 194;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET1_DIGEST_0_OFFSET = 16'h 198;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET1_DIGEST_1_OFFSET = 16'h 19c;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET2_DIGEST_0_OFFSET = 16'h 1a0;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET2_DIGEST_1_OFFSET = 16'h 1a4;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET3_DIGEST_0_OFFSET = 16'h 1a8;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET3_DIGEST_1_OFFSET = 16'h 1ac;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET4_DIGEST_0_OFFSET = 16'h 1b0;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET4_DIGEST_1_OFFSET = 16'h 1b4;
  ...
  parameter logic [3:0] OTP_CTRL_CORE_PERMIT [110] = '{
    ...
    4'b 1111, // index[ 64] OTP_CTRL_VENDOR_TEST_DIGEST_0
    4'b 1111, // index[ 65] OTP_CTRL_VENDOR_TEST_DIGEST_1
    4'b 1111, // index[ 66] OTP_CTRL_CREATOR_SW_CFG_DIGEST_0
    4'b 1111, // index[ 67] OTP_CTRL_CREATOR_SW_CFG_DIGEST_1
    4'b 1111, // index[ 68] OTP_CTRL_OWNER_SW_CFG_DIGEST_0
    4'b 1111, // index[ 69] OTP_CTRL_OWNER_SW_CFG_DIGEST_1
    4'b 1111, // index[ 70] OTP_CTRL_ROT_CREATOR_IDENTITY_DIGEST_0
    4'b 1111, // index[ 71] OTP_CTRL_ROT_CREATOR_IDENTITY_DIGEST_1
    4'b 1111, // index[ 72] OTP_CTRL_ROT_OWNER_AUTH_SLOT0_DIGEST_0
    4'b 1111, // index[ 73] OTP_CTRL_ROT_OWNER_AUTH_SLOT0_DIGEST_1
    4'b 1111, // index[ 74] OTP_CTRL_ROT_OWNER_AUTH_SLOT1_DIGEST_0
    4'b 1111, // index[ 75] OTP_CTRL_ROT_OWNER_AUTH_SLOT1_DIGEST_1
    4'b 1111, // index[ 76] OTP_CTRL_PLAT_INTEG_AUTH_SLOT0_DIGEST_0
    4'b 1111, // index[ 77] OTP_CTRL_PLAT_INTEG_AUTH_SLOT0_DIGEST_1
    4'b 1111, // index[ 78] OTP_CTRL_PLAT_INTEG_AUTH_SLOT1_DIGEST_0
    4'b 1111, // index[ 79] OTP_CTRL_PLAT_INTEG_AUTH_SLOT1_DIGEST_1
    4'b 1111, // index[ 80] OTP_CTRL_PLAT_OWNER_AUTH_SLOT0_DIGEST_0
    4'b 1111, // index[ 81] OTP_CTRL_PLAT_OWNER_AUTH_SLOT0_DIGEST_1
    4'b 1111, // index[ 82] OTP_CTRL_PLAT_OWNER_AUTH_SLOT1_DIGEST_0
    4'b 1111, // index[ 83] OTP_CTRL_PLAT_OWNER_AUTH_SLOT1_DIGEST_1
    4'b 1111, // index[ 84] OTP_CTRL_PLAT_OWNER_AUTH_SLOT2_DIGEST_0
    4'b 1111, // index[ 85] OTP_CTRL_PLAT_OWNER_AUTH_SLOT2_DIGEST_1
    4'b 1111, // index[ 86] OTP_CTRL_PLAT_OWNER_AUTH_SLOT3_DIGEST_0
    4'b 1111, // index[ 87] OTP_CTRL_PLAT_OWNER_AUTH_SLOT3_DIGEST_1
    4'b 1111, // index[ 88] OTP_CTRL_ROM_PATCH_DIGEST_0
    4'b 1111, // index[ 89] OTP_CTRL_ROM_PATCH_DIGEST_1
    4'b 1111, // index[ 90] OTP_CTRL_SOC_FUSES_CP_DIGEST_0
    4'b 1111, // index[ 91] OTP_CTRL_SOC_FUSES_CP_DIGEST_1
    4'b 1111, // index[ 92] OTP_CTRL_SOC_FUSES_FT_DIGEST_0
    4'b 1111, // index[ 93] OTP_CTRL_SOC_FUSES_FT_DIGEST_1
    4'b 1111, // index[ 94] OTP_CTRL_HW_CFG0_DIGEST_0
    4'b 1111, // index[ 95] OTP_CTRL_HW_CFG0_DIGEST_1
    4'b 1111, // index[ 96] OTP_CTRL_HW_CFG1_DIGEST_0
    4'b 1111, // index[ 97] OTP_CTRL_HW_CFG1_DIGEST_1
    4'b 1111, // index[ 98] OTP_CTRL_HW_CFG2_DIGEST_0
    4'b 1111, // index[ 99] OTP_CTRL_HW_CFG2_DIGEST_1
    4'b 1111, // index[100] OTP_CTRL_SECRET0_DIGEST_0
    4'b 1111, // index[101] OTP_CTRL_SECRET0_DIGEST_1
    4'b 1111, // index[102] OTP_CTRL_SECRET1_DIGEST_0
    4'b 1111, // index[103] OTP_CTRL_SECRET1_DIGEST_1
    4'b 1111, // index[104] OTP_CTRL_SECRET2_DIGEST_0
    4'b 1111, // index[105] OTP_CTRL_SECRET2_DIGEST_1
    4'b 1111, // index[106] OTP_CTRL_SECRET3_DIGEST_0
    4'b 1111, // index[107] OTP_CTRL_SECRET3_DIGEST_1
    4'b 1111, // index[108] OTP_CTRL_SECRET4_DIGEST_0
    4'b 1111  // index[109] OTP_CTRL_SECRET4_DIGEST_1
  };
