...
module otp_ctrl_cov_bind;
  ...
  `PART_MUBI_COV(creator_manuf_cfg, otp_ctrl_part_pkg::CreatorManufCfgIdx)
  ...
  `PART_MUBI_COV(secret4, otp_ctrl_part_pkg::Secret4Idx)
  ...
  `DAI_MUBI_COV(creator_manuf_cfg, otp_ctrl_part_pkg::CreatorManufCfgIdx)
  ...
  `DAI_MUBI_COV(secret4, otp_ctrl_part_pkg::Secret4Idx)
