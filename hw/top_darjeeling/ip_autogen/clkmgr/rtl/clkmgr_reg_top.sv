...
module clkmgr_reg_top (
  ...
  always_comb begin
    ...
    addr_hit[ 8] = (reg_addr == CLKMGR_IO_MEAS_CTRL_EN_OFFSET);
    addr_hit[ 9] = (reg_addr == CLKMGR_IO_MEAS_CTRL_SHADOWED_OFFSET);
    addr_hit[10] = (reg_addr == CLKMGR_MAIN_MEAS_CTRL_EN_OFFSET);
    addr_hit[11] = (reg_addr == CLKMGR_MAIN_MEAS_CTRL_SHADOWED_OFFSET);
    addr_hit[12] = (reg_addr == CLKMGR_RECOV_ERR_CODE_OFFSET);
    addr_hit[13] = (reg_addr == CLKMGR_FATAL_ERR_CODE_OFFSET);
  end
  ...
  assign jitter_regwen_we = addr_hit[2] & reg_we & !reg_error;
  ...
  assign recov_err_code_we = addr_hit[12] & reg_we & !reg_error;
  ...
  always_comb begin
    ...
    reg_we_check[3] = jitter_enable_gated_we;
    reg_we_check[4] = clk_enables_we;
    reg_we_check[5] = clk_hints_we;
    reg_we_check[6] = 1'b0;
    reg_we_check[7] = measure_ctrl_regwen_we;
    reg_we_check[8] = io_meas_ctrl_en_we;
    reg_we_check[9] = io_meas_ctrl_shadowed_we;
    reg_we_check[10] = main_meas_ctrl_en_we;
    reg_we_check[11] = main_meas_ctrl_shadowed_we;
    reg_we_check[12] = recov_err_code_we;
