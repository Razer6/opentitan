...
//
// xbar_mio_peri module generated by `tlgen.py` tool
...
module xbar_mio_peri (
  input clk_peri_i,
  input rst_peri_ni,

  // Host interfaces
  input  tlul_pkg::tl_h2d_t tl_mio_main_i,
  output tlul_pkg::tl_d2h_t tl_mio_main_o,
  ...
  assign tl_s1n_5_us_h2d = tl_mio_main_i;
  assign tl_mio_main_o = tl_s1n_5_us_d2h;
