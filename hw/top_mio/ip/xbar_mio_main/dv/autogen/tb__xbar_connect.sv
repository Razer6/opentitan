...
`CONNECT_TL_HOST_IF(rv_core_ibex_mio__corei, dut, clk_main_i, rst_n)
`CONNECT_TL_HOST_IF(rv_core_ibex_mio__cored, dut, clk_main_i, rst_n)
...
`CONNECT_TL_DEVICE_IF(mio_peri, dut, clk_fixed_i, rst_n)
`CONNECT_TL_DEVICE_IF(mio_soc_proxy__ctn, dut, clk_main_i, rst_n)
`CONNECT_TL_DEVICE_IF(rv_plic_mio, dut, clk_main_i, rst_n)
`CONNECT_TL_DEVICE_IF(rv_core_ibex_mio__cfg, dut, clk_main_i, rst_n)
