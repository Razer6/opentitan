...
//
// xbar_mio_main module generated by `tlgen.py` tool
...
module xbar_mio_main (
  ...
  output tlul_pkg::tl_h2d_t tl_mio_peri_o,
  input  tlul_pkg::tl_d2h_t tl_mio_peri_i,
  output tlul_pkg::tl_h2d_t tl_mio_soc_proxy__ctn_o,
  ...
  assign tl_mio_peri_o = tl_asf_35_ds_h2d;
  assign tl_asf_35_ds_d2h = tl_mio_peri_i;

  assign tl_asf_35_us_h2d = tl_sm1_36_ds_h2d;
  assign tl_sm1_36_ds_d2h = tl_asf_35_us_d2h;

  assign tl_rv_plic_mio_o = tl_sm1_37_ds_h2d;
  assign tl_sm1_37_ds_d2h = tl_rv_plic_mio_i;
  ...
  always_comb begin
    ...
    if ((tl_s1n_33_us_h2d.a_address &
      ...
      dev_sel_s1n_33 = 5'd2;
                  ...
                  ~(ADDR_MASK_MIO_PERI)) == ADDR_SPACE_MIO_PERI) begin
      dev_sel_s1n_33 = 5'd3;

    end else if ((tl_s1n_33_us_h2d.a_address &
                  ~(ADDR_MASK_RV_PLIC_MIO)) == ADDR_SPACE_RV_PLIC_MIO) begin
      dev_sel_s1n_33 = 5'd4;
