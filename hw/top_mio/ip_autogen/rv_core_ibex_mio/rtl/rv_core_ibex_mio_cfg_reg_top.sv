...
module rv_core_ibex_mio_cfg_reg_top
  # (
  ...
  // To HW
  output rv_core_ibex_mio_reg_pkg::rv_core_ibex_mio_cfg_reg2hw_t reg2hw, // Write
  input  rv_core_ibex_mio_reg_pkg::rv_core_ibex_mio_cfg_hw2reg_t hw2reg, // Read
  ...
  always_comb begin
    ...
    addr_hit[ 0] = (reg_addr == RV_CORE_IBEX_MIO_ALERT_TEST_OFFSET);
    addr_hit[ 1] = (reg_addr == RV_CORE_IBEX_MIO_SW_RECOV_ERR_OFFSET);
    addr_hit[ 2] = (reg_addr == RV_CORE_IBEX_MIO_SW_FATAL_ERR_OFFSET);
    addr_hit[ 3] = (reg_addr == RV_CORE_IBEX_MIO_IBUS_REGWEN_0_OFFSET);
    addr_hit[ 4] = (reg_addr == RV_CORE_IBEX_MIO_IBUS_REGWEN_1_OFFSET);
    addr_hit[ 5] = (reg_addr == RV_CORE_IBEX_MIO_IBUS_ADDR_EN_0_OFFSET);
    addr_hit[ 6] = (reg_addr == RV_CORE_IBEX_MIO_IBUS_ADDR_EN_1_OFFSET);
    addr_hit[ 7] = (reg_addr == RV_CORE_IBEX_MIO_IBUS_ADDR_MATCHING_0_OFFSET);
    addr_hit[ 8] = (reg_addr == RV_CORE_IBEX_MIO_IBUS_ADDR_MATCHING_1_OFFSET);
    addr_hit[ 9] = (reg_addr == RV_CORE_IBEX_MIO_IBUS_REMAP_ADDR_0_OFFSET);
    addr_hit[10] = (reg_addr == RV_CORE_IBEX_MIO_IBUS_REMAP_ADDR_1_OFFSET);
    addr_hit[11] = (reg_addr == RV_CORE_IBEX_MIO_DBUS_REGWEN_0_OFFSET);
    addr_hit[12] = (reg_addr == RV_CORE_IBEX_MIO_DBUS_REGWEN_1_OFFSET);
    addr_hit[13] = (reg_addr == RV_CORE_IBEX_MIO_DBUS_ADDR_EN_0_OFFSET);
    addr_hit[14] = (reg_addr == RV_CORE_IBEX_MIO_DBUS_ADDR_EN_1_OFFSET);
    addr_hit[15] = (reg_addr == RV_CORE_IBEX_MIO_DBUS_ADDR_MATCHING_0_OFFSET);
    addr_hit[16] = (reg_addr == RV_CORE_IBEX_MIO_DBUS_ADDR_MATCHING_1_OFFSET);
    addr_hit[17] = (reg_addr == RV_CORE_IBEX_MIO_DBUS_REMAP_ADDR_0_OFFSET);
    addr_hit[18] = (reg_addr == RV_CORE_IBEX_MIO_DBUS_REMAP_ADDR_1_OFFSET);
    addr_hit[19] = (reg_addr == RV_CORE_IBEX_MIO_NMI_ENABLE_OFFSET);
    addr_hit[20] = (reg_addr == RV_CORE_IBEX_MIO_NMI_STATE_OFFSET);
    addr_hit[21] = (reg_addr == RV_CORE_IBEX_MIO_ERR_STATUS_OFFSET);
    addr_hit[22] = (reg_addr == RV_CORE_IBEX_MIO_RND_DATA_OFFSET);
    addr_hit[23] = (reg_addr == RV_CORE_IBEX_MIO_RND_STATUS_OFFSET);
    addr_hit[24] = (reg_addr == RV_CORE_IBEX_MIO_FPGA_INFO_OFFSET);
  ...
  always_comb begin
    wr_err = (reg_we &
              ((racl_addr_hit_write[ 0] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[ 0] & ~reg_be))) |
               (racl_addr_hit_write[ 1] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[ 1] & ~reg_be))) |
               (racl_addr_hit_write[ 2] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[ 2] & ~reg_be))) |
               (racl_addr_hit_write[ 3] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[ 3] & ~reg_be))) |
               (racl_addr_hit_write[ 4] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[ 4] & ~reg_be))) |
               (racl_addr_hit_write[ 5] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[ 5] & ~reg_be))) |
               (racl_addr_hit_write[ 6] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[ 6] & ~reg_be))) |
               (racl_addr_hit_write[ 7] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[ 7] & ~reg_be))) |
               (racl_addr_hit_write[ 8] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[ 8] & ~reg_be))) |
               (racl_addr_hit_write[ 9] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[ 9] & ~reg_be))) |
               (racl_addr_hit_write[10] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[10] & ~reg_be))) |
               (racl_addr_hit_write[11] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[11] & ~reg_be))) |
               (racl_addr_hit_write[12] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[12] & ~reg_be))) |
               (racl_addr_hit_write[13] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[13] & ~reg_be))) |
               (racl_addr_hit_write[14] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[14] & ~reg_be))) |
               (racl_addr_hit_write[15] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[15] & ~reg_be))) |
               (racl_addr_hit_write[16] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[16] & ~reg_be))) |
               (racl_addr_hit_write[17] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[17] & ~reg_be))) |
               (racl_addr_hit_write[18] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[18] & ~reg_be))) |
               (racl_addr_hit_write[19] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[19] & ~reg_be))) |
               (racl_addr_hit_write[20] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[20] & ~reg_be))) |
               (racl_addr_hit_write[21] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[21] & ~reg_be))) |
               (racl_addr_hit_write[22] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[22] & ~reg_be))) |
               (racl_addr_hit_write[23] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[23] & ~reg_be))) |
               (racl_addr_hit_write[24] & (|(RV_CORE_IBEX_MIO_CFG_PERMIT[24] & ~reg_be)))));
  end
