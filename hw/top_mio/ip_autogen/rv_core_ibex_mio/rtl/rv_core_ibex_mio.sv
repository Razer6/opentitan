 ...
 */
module rv_core_ibex_mio
  import rv_core_ibex_pkg::*;
  import rv_core_ibex_mio_reg_pkg::*;
#(
  ...
  parameter top_racl_pkg::racl_policy_sel_t RaclPolicySelVec[rv_core_ibex_mio_reg_pkg::NumRegsCfg] = 
    '{rv_core_ibex_mio_reg_pkg::NumRegsCfg{0}},
  ...
  // Register module
  rv_core_ibex_mio_cfg_reg2hw_t reg2hw;
  rv_core_ibex_mio_cfg_hw2reg_t hw2reg;
