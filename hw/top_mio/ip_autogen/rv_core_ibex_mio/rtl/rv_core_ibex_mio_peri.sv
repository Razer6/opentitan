...
module rv_core_ibex_mio_peri
  import rv_core_ibex_mio_peri_pkg::*;
  import rv_core_ibex_mio_peri_reg_pkg::*;
#(
  ...
  // alert events from rv_core_ibex_mio
  ...
  // Register module
  rv_core_ibex_mio_peri_reg2hw_t reg2hw;
  rv_core_ibex_mio_peri_hw2reg_t hw2reg;

  logic intg_err;
  rv_core_ibex_mio_peri_reg_top u_reg (
    .clk_i,
    .rst_ni,
    .tl_i,
    .tl_o,
...
endmodule // rv_core_ibex_mio_peri
