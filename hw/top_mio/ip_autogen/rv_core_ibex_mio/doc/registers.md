...
| rv_core_ibex_mio.[`DBUS_ADDR_MATCHING_0`](#dbus_addr_matching) | 0x3c     |        4 | See !!IBUS_ADDR_MATCHING_0 for detailed description. |
| rv_core_ibex_mio.[`DBUS_ADDR_MATCHING_1`](#dbus_addr_matching) | 0x40     |        4 | See !!IBUS_ADDR_MATCHING_0 for detailed description. |
| rv_core_ibex_mio.[`DBUS_REMAP_ADDR_0`](#dbus_remap_addr)       | 0x44     |        4 | See !!IBUS_REMAP_ADDR_0 for a detailed description.  |
| rv_core_ibex_mio.[`DBUS_REMAP_ADDR_1`](#dbus_remap_addr)       | 0x48     |        4 | See !!IBUS_REMAP_ADDR_0 for a detailed description.  |
...
| rv_core_ibex_mio.[`RND_STATUS`](#rnd_status)                   | 0x5c     |        4 | Status of random data in !!RND_DATA                  |
