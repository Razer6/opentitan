...
module ac_range_check_mio
  import tlul_pkg::*;
  import ac_range_check_mio_reg_pkg::*;
#(
  ...
  ac_range_check_mio_reg2hw_t reg2hw;
  ac_range_check_mio_hw2reg_t hw2reg;
