...
<!-- BEGIN CMDGEN util/regtool.py --interfaces ./hw/top_mio/ip_autogen/ac_range_check_mio/data/ac_range_check_mio.hjson -->
Referring to the [Comportable guideline for peripheral device functionality](https://opentitan.org/book/doc/contributing/hw/comportability), the module **`ac_range_check_mio`** has the following hardware interfaces defined
- Primary Clock: **`clk_i`**
- Other Clocks: *none*
