...
module rv_plic_mio_reg_top
  ...
  logic [44:0] racl_addr_hit_read;
  logic [44:0] racl_addr_hit_write;
  ...
  always_comb begin
    ...
    addr_hit[37] = (reg_addr == RV_PLIC_MIO_IP_0_OFFSET);
    addr_hit[38] = (reg_addr == RV_PLIC_MIO_IP_1_OFFSET);
    addr_hit[39] = (reg_addr == RV_PLIC_MIO_IE0_0_OFFSET);
    addr_hit[40] = (reg_addr == RV_PLIC_MIO_IE0_1_OFFSET);
    addr_hit[41] = (reg_addr == RV_PLIC_MIO_THRESHOLD0_OFFSET);
    addr_hit[42] = (reg_addr == RV_PLIC_MIO_CC0_OFFSET);
    addr_hit[43] = (reg_addr == RV_PLIC_MIO_MSIP0_OFFSET);
    addr_hit[44] = (reg_addr == RV_PLIC_MIO_ALERT_TEST_OFFSET);

    if (EnableRacl) begin : gen_racl_hit
      for (int unsigned slice_idx = 0; slice_idx < 45; slice_idx++) begin
  ...
  assign ie0_0_we = racl_addr_hit_write[39] & reg_we & !reg_error;
  ...
  assign ie0_1_we = racl_addr_hit_write[40] & reg_we & !reg_error;
  ...
  assign threshold0_we = racl_addr_hit_write[41] & reg_we & !reg_error;

  assign threshold0_wd = reg_wdata[1:0];
  assign cc0_re = racl_addr_hit_read[42] & reg_re & !reg_error;
  assign cc0_we = racl_addr_hit_write[42] & reg_we & !reg_error;

  assign cc0_wd = reg_wdata[5:0];
  assign msip0_we = racl_addr_hit_write[43] & reg_we & !reg_error;

  assign msip0_wd = reg_wdata[0];
  assign alert_test_we = racl_addr_hit_write[44] & reg_we & !reg_error;
  ...
  always_comb begin
    ...
    reg_we_check[39] = ie0_0_we;
    reg_we_check[40] = ie0_1_we;
    reg_we_check[41] = threshold0_we;
    reg_we_check[42] = cc0_we;
    reg_we_check[43] = msip0_we;
    reg_we_check[44] = alert_test_we;
  end
