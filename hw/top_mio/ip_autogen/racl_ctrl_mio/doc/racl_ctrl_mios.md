...
<!-- BEGIN CMDGEN util/regtool.py --interfaces ./hw/top_mio/ip_autogen/racl_ctrl_mio/data/racl_ctrl_mio.hjson -->
Referring to the [Comportable guideline for peripheral device functionality](https://opentitan.org/book/doc/contributing/hw/comportability), the module **`racl_ctrl_mio`** has the following hardware interfaces defined
- Primary Clock: **`clk_i`**
- Other Clocks: *none*
...
|:----------------------------------------|:------------------------------------|
| RACL_CTRL_MIO.BUS.INTEGRITY             | End-to-end bus integrity scheme.    |
| RACL_CTRL_MIO.RACL_POLICY.CONFIG.SHADOW | RACL policy registers are shadowed. |
