...
|:----------------------------------------------------------------------------------------------|:---------|---------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| racl_ctrl_mio.[`ALERT_TEST`](#alert_test)                                                     | 0x0      |        4 | Alert Test Register                                                                                                                                                                                                                                                                                                                                                                                                                               |
| racl_ctrl_mio.[`ERROR_LOG`](#error_log)                                                       | 0x4      |        4 | Error logging registers                                                                                                                                                                                                                                                                                                                                                                                                                           |
| racl_ctrl_mio.[`POLICY_ALL_RD_WR_SHADOWED`](#policy_all_rd_wr_shadowed)                       | 0x8      |        4 | Read and write policy for {'name': 'ALL_RD_WR', 'allowed_wr': ['NOT_TEE', 'M_MODE', 'TEE_MODE', 'R_CODE', 'CAT2_DEBUG', 'CAT3_DEBUG', 'ROT', 'MIO', 'PWC', 'INT_SOC', 'IO_AGENT', 'TEE_IO_AGENT', 'DUC_UC', 'MIMT_R_MODE'], 'allowed_rd': ['NOT_TEE', 'M_MODE', 'TEE_MODE', 'R_CODE', 'CAT2_DEBUG', 'CAT3_DEBUG', 'ROT', 'MIO', 'PWC', 'INT_SOC', 'IO_AGENT', 'TEE_IO_AGENT', 'DUC_UC', 'MIMT_R_MODE'], 'rd_default': 16383, 'wr_default': 16383} |
| racl_ctrl_mio.[`POLICY_HW_ROT_PWC_WR_ALL_RD_SHADOWED`](#policy_hw_rot_pwc_wr_all_rd_shadowed) | 0xc      |        4 | Read and write policy for {'name': 'HW_ROT_PWC_WR_ALL_RD', 'allowed_wr': ['CAT3_DEBUG', 'ROT', 'PWC', 'INT_SOC'], 'allowed_rd': ['NOT_TEE', 'M_MODE', 'TEE_MODE', 'R_CODE', 'CAT2_DEBUG', 'CAT3_DEBUG', 'ROT', 'MIO', 'PWC', 'INT_SOC', 'IO_AGENT', 'TEE_IO_AGENT', 'DUC_UC', 'MIMT_R_MODE'], 'rd_default': 16383, 'wr_default': 864}                                                                                                             |
| racl_ctrl_mio.[`POLICY_PRE_BOOT_M_SHADOWED`](#policy_pre_boot_m_shadowed)                     | 0x10     |        4 | Read and write policy for {'name': 'PRE_BOOT_M', 'allowed_wr': ['M_MODE', 'R_CODE', 'CAT2_DEBUG', 'CAT3_DEBUG', 'ROT', 'PWC', 'INT_SOC'], 'allowed_rd': ['NOT_TEE', 'M_MODE', 'TEE_MODE', 'R_CODE', 'CAT2_DEBUG', 'CAT3_DEBUG', 'ROT', 'MIO', 'PWC', 'INT_SOC'], 'rd_default': 1023, 'wr_default': 890}                                                                                                                                           |
| racl_ctrl_mio.[`POLICY_POST_BOOT_M_SHADOWED`](#policy_post_boot_m_shadowed)                   | 0x14     |        4 | Read and write policy for {'name': 'POST_BOOT_M', 'allowed_wr': ['M_MODE', 'R_CODE', 'CAT2_DEBUG', 'CAT3_DEBUG', 'ROT', 'PWC', 'INT_SOC'], 'allowed_rd': ['NOT_TEE', 'M_MODE', 'TEE_MODE', 'R_CODE', 'CAT2_DEBUG', 'CAT3_DEBUG', 'ROT', 'MIO', 'PWC', 'INT_SOC'], 'rd_default': 1023, 'wr_default': 890}                                                                                                                                          |
| racl_ctrl_mio.[`POLICY_TEE_LIMITED_SHADOWED`](#policy_tee_limited_shadowed)                   | 0x18     |        4 | Read and write policy for {'name': 'TEE_LIMITED', 'allowed_wr': ['TEE_MODE', 'R_CODE', 'CAT2_DEBUG', 'CAT3_DEBUG', 'ROT', 'PWC', 'INT_SOC', 'TEE_IO_AGENT'], 'allowed_rd': ['TEE_MODE', 'R_CODE', 'CAT2_DEBUG', 'CAT3_DEBUG', 'ROT', 'PWC', 'INT_SOC', 'TEE_IO_AGENT'], 'rd_default': 2940, 'wr_default': 2940}                                                                                                                                   |
| racl_ctrl_mio.[`POLICY_RCODE_PRIVATE_SHADOWED`](#policy_rcode_private_shadowed)               | 0x1c     |        4 | Read and write policy for {'name': 'RCODE_PRIVATE', 'allowed_wr': ['R_CODE', 'CAT3_DEBUG', 'ROT', 'PWC', 'INT_SOC'], 'allowed_rd': ['R_CODE', 'CAT3_DEBUG', 'ROT', 'PWC', 'INT_SOC'], 'rd_default': 872, 'wr_default': 872}                                                                                                                                                                                                                       |
| racl_ctrl_mio.[`POLICY_ROT_PRIVATE_SHADOWED`](#policy_rot_private_shadowed)                   | 0x20     |        4 | Read and write policy for {'name': 'ROT_PRIVATE', 'rot_private': True, 'allowed_wr': ['CAT3_DEBUG', 'ROT'], 'allowed_rd': ['CAT3_DEBUG', 'ROT'], 'rd_default': 96, 'wr_default': 96}                                                                                                                                                                                                                                                              |
| racl_ctrl_mio.[`POLICY_PWC_PRIVATE_SHADOWED`](#policy_pwc_private_shadowed)                   | 0x24     |        4 | Read and write policy for {'name': 'PWC_PRIVATE', 'allowed_wr': ['CAT3_DEBUG', 'ROT', 'PWC', 'INT_SOC'], 'allowed_rd': ['CAT3_DEBUG', 'ROT', 'PWC', 'INT_SOC'], 'rd_default': 864, 'wr_default': 864}                                                                                                                                                                                                                                             |
| racl_ctrl_mio.[`POLICY_MIO_PRIVATE_SHADOWED`](#policy_mio_private_shadowed)                   | 0x28     |        4 | Read and write policy for {'name': 'MIO_PRIVATE', 'allowed_wr': ['CAT3_DEBUG', 'ROT', 'MIO', 'PWC', 'INT_SOC'], 'allowed_rd': ['CAT3_DEBUG', 'ROT', 'MIO', 'PWC', 'INT_SOC'], 'rd_default': 992, 'wr_default': 992}                                                                                                                                                                                                                               |
| racl_ctrl_mio.[`POLICY_DUC_PRIVATE_SHADOWED`](#policy_duc_private_shadowed)                   | 0x2c     |        4 | Read and write policy for {'name': 'DUC_PRIVATE', 'allowed_wr': ['CAT3_DEBUG', 'ROT', 'PWC', 'INT_SOC', 'DUC_UC', 'MIMT_R_MODE'], 'allowed_rd': ['CAT3_DEBUG', 'ROT', 'PWC', 'INT_SOC', 'DUC_UC', 'MIMT_R_MODE'], 'rd_default': 13152, 'wr_default': 13152}                                                                                                                                                                                       |
