...
module xbar_peri (
  ...
  output tlul_pkg::tl_h2d_t tl_otp_macro_o,
  input  tlul_pkg::tl_d2h_t tl_otp_macro_i,
  ...
  assign tl_otp_macro_o = tl_s1n_28_ds_h2d[16];
  assign tl_s1n_28_ds_d2h[16] = tl_otp_macro_i;

  assign tl_lc_ctrl__regs_o = tl_s1n_28_ds_h2d[17];
  assign tl_s1n_28_ds_d2h[17] = tl_lc_ctrl__regs_i;

  assign tl_sensor_ctrl_aon_o = tl_s1n_28_ds_h2d[18];
  assign tl_s1n_28_ds_d2h[18] = tl_sensor_ctrl_aon_i;
  ...
  always_comb begin
    ...
    if ((tl_s1n_28_us_h2d.a_address &
      ...
      dev_sel_s1n_28 = 5'd15;
                  ...
                  ~(ADDR_MASK_OTP_MACRO)) == ADDR_SPACE_OTP_MACRO) begin
